...
h0EndcapPlus['candBinning']                   = [5*50,0,5*50]
h0EndcapMinus['candBinning']                  = [5*50,0,5*50]
gammaBarrel['candBinning']                    = [5*25,0,5*500]
gammaEndcapPlus['candBinning']                = [5*25,0,5*150]
gammaEndcapMinus['candBinning']               = [5*25,0,5*150]
gammaForwardPlus['candBinning']               = [5*10,0,5*10]
gammaForwardMinus['candBinning']              = [5*10,0,5*10]
e['candBinning']                              = [5*10,0,5*10]
...
#h_HF_InnerMostRingsMinus['nvtxBinning']        = [50, 0, 50]
#h_HF_InnerMostRingsPlus['nvtxBinning']         = [50, 0, 50]
egamma_HF_Minus['nvtxBinning']                 = [50, 0, 50]
egamma_HF_Plus['nvtxBinning']                  = [50, 0, 50]
#egamma_HF_InnerMostRingsMinus['nvtxBinning']   = [50, 0, 50]
#egamma_HF_InnerMostRingsPlus['nvtxBinning']    = [50, 0, 50]
#h_HF['nvtxBinning']                            = [50, 0, 50]
#egamma_HF['nvtxBinning']                       = [50, 0, 50]
#variable 2
...
#h_HF_InnerMostRingsMinus['sumETBinning']       = [5*25,0,5*50]
#h_HF_InnerMostRingsPlus['sumETBinning']        = [5*25,0,5*50]
egamma_HF_Minus['sumETBinning']                = [5*25,0,5*250]
egamma_HF_Plus['sumETBinning']                 = [5*25,0,5*250]
#egamma_HF_InnerMostRingsMinus['sumETBinning']  = [5*25,0,5*50]
#egamma_HF_InnerMostRingsPlus['sumETBinning']   = [5*25,0,5*50]
