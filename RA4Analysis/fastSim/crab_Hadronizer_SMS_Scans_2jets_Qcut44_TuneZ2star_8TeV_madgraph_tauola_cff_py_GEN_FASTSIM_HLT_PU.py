...
# with command line options: Hadronizer_SMS_Scans_2jets_Qcut44_TuneZ2star_8TeV_madgraph_tauola_cff.py --eventcontent AODSIM --pileup 2012_Summer_inTimeOnly --datatier AODSIM --conditions START53_V7C::All --beamspot Realistic8TeVCollision --step GEN,FASTSIM,HLT:7E33v2 --filein=file:/data/schoef/lhe/decayed_gluino_gluino/histo_1100_100_decoupled.root -n -1 --no_exec
...
#
#options.infile = 'infile.root'
#options.maxEvents=-1
#options.skipEvents=0
#options.outfile='histo.root'
#
...
process.source = cms.Source("PoolSource",
    ...
    fileNames = cms.untracked.vstring('histo.root'),
...
process.configurationMetadata = cms.untracked.PSet(
    ...
    annotation = cms.untracked.string('Hadronizer_SMS_Scans_2jets_Qcut44_TuneZ2star_8TeV_madgraph_tauola_cff.py nevts:-1'),
