...
variable = "ht"	 #variable to plot
cut =	"(singleMuonic&&nvetoMuons==1&&nvetoElectrons==0||singleElectronic&&nvetoElectrons==1&&nvetoMuons==0)&&met>150&&njets>=3"		 #cut to use
#cut =	"(singleMuonic OR singleElectronic)&&ht>400&&met>150&&nbtags>=2"		 #cut to use
binning = [100,0,2500]		 #binning
