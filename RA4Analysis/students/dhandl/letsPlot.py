import ROOT
#ROOT.gROOT.ProcessLine(".L ../CMSSW_5_3_3_patch2/src/Workspace/Scripts/aclic/tdrstyle.C")
#ROOT.setTDRStyle()
from xsec import xsec

small = False                       		 #Steering for this script. Use True for development
variable = "met"                    		 #The variable to plot
cut = "singleMuonic&&ht>400&&met>150&&nvetoMuons==1&&nvetoElectrons==0&&nbtags>=2" #The cut to use
binning = [100,0,1000]               		 #binning
...
#cData.Add("/data/mhickel/pat_120927/data8TeV/MuHad-Run2012C-PromptReco/histo_*root")
cData.Add("/data/mhickel/pat_120929/data8TeV/MuHad-Run2012C-PromptReco-v2/"+hString)

targetLumi = 5000. + 6303 + 489 + 7274

cTTbar = ROOT.TChain("Events")
cTTbar.Add("/data/mhickel/pat_120917/mc8TeV/8TeV-TTJets/"+hString)
dTTbar = ROOT.TChain("Runs")        #Now count number of MC events
for c in [cTTbar, dTTbar]:
  dTTbar.Add("/data/mhickel/pat_120917/mc8TeV/8TeV-TTJets/"+hString)
