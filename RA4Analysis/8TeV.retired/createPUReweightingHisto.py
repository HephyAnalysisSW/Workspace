...
S12 = ROOT.TH1F("S12", "S12", 60,0,60)
for i in range(60):
  S12.SetBinContent(i+1, ROOT.Summer2012_S12[i])
S12.Scale(1./S12.Integral())
...
tf = ROOT.TFile("/data/schoef/tools/PU/MyDataPileupHistogram_Run2012ABCD_60max_true_pixelcorr_Sys0.root")
ROOT.gDirectory.cd("PyROOT:/")
reweightingHisto = tf.Get("pileup").Clone("ngoodVertices_Data")
tf.Close()
reweightingHisto.Scale(1./reweightingHisto.Integral())
reweightingHisto.Divide(S12)
tf = ROOT.TFile("/data/schoef/tools/PU/reweightingHisto_Summer2012-S12-Run2012ABCD_60max_true_pixelcorr_Sys0.root", "recreate")
reweightingHisto.Write()
tf.Close()

tf = ROOT.TFile("/data/schoef/tools/PU/MyDataPileupHistogram_Run2012ABCD_60max_true_pixelcorr_SysMinus5.root")
ROOT.gDirectory.cd("PyROOT:/")
reweightingHisto = tf.Get("pileup").Clone("ngoodVertices_Data")
tf.Close()
reweightingHisto.Scale(1./reweightingHisto.Integral())
reweightingHisto.Divide(S12)
tf = ROOT.TFile("PU/reweightingHisto_Summer2012-S12-Run2012ABCD_60max_true_pixelcorr_SysPlus5.root", "recreate")
reweightingHisto.Write()
tf.Close()

tf = ROOT.TFile("/data/schoef/tools/PU/MyDataPileupHistogram_Run2012ABCD_60max_true_pixelcorr_SysPlus5.root")
ROOT.gDirectory.cd("PyROOT:/")
reweightingHisto = tf.Get("pileup").Clone("ngoodVertices_Data")
tf.Close()
reweightingHisto.Scale(1./reweightingHisto.Integral())
reweightingHisto.Divide(S12)
tf = ROOT.TFile("PU/reweightingHisto_Summer2012-S12-Run2012ABCD_60max_true_pixelcorr_SysMinus5.root", "recreate")
reweightingHisto.Write()
tf.Close()
