...
#    c1.Print('/afs/hephy.at/user/s/schoefbeck/www/pngCMG/'+prefix+'_yield_njet_vs_ht_'+name+'_'+nameAndCut(stb,htb=None,njetb=None,btb=None, presel=presel)[0]+".png")
#  hRatio  = yield_2d['W'][stb].Clone()
#  hAll    = yield_2d['TT'][stb].Clone()
#  hAll.Add(hRatio)
#  hRatio.Divide(hAll)
#  hRatio.Draw('COLZTEXT')
#  c1.Print('/afs/hephy.at/user/s/schoefbeck/www/pngCMG/'+prefix+'_wRatio_njet_vs_ht_'+name+'_'+nameAndCut(stb,htb=None,njetb=None, btb=None,presel=presel)[0]+".png")
#  del hRatio, hAll
#  
#
#
...
#    l.Draw()
#    c1.Print('/afs/hephy.at/user/s/schoefbeck/www/pngCMG/'+prefix+'_rCS_njet_'+name+'_'+nameAndCut(stb,htb=None,njetb=None, btb=None, presel=presel)[0]+".png")
#    h_2d[name][stb].Draw('COLZ')
#    c1.Print('/afs/hephy.at/user/s/schoefbeck/www/pngCMG/'+prefix+'_rCS_njet_vs_ht_'+name+'_'+nameAndCut(stb,htb=None,njetb=None, btb=None, presel=presel)[0]+".png")
#  for htb in htreg:
#    c1 = ROOT.TCanvas()
#    first = True 
#    l = ROOT.TLegend(0.1,0.75,0.4,0.9)
...
#        h_nj[name][stb][htb].Draw('same')
#    l.Draw()
#    c1.Print('/afs/hephy.at/user/s/schoefbeck/www/pngCMG/'+prefix+'_rCS_njet_'+name+'_'+nameAndCut(stb=None,htb=htb,njetb=None, btb=None presel=presel)[0]+".png")
#for name, c in [ ["W",cWJets], ["TT", cTTJets]]:
#  for stb, dPhiCut in streg:
#    c1 = ROOT.TCanvas()
#    first = True 
...
#    l.Draw()
#    c1.Print('/afs/hephy.at/user/s/schoefbeck/www/pngCMG/'+prefix+'_rCS_ht_'+name+'_'+nameAndCut(stb,htb=None,njetb=None, btb=None,presel=presel)[0]+".png")
#  for njb in njreg:
#    c1 = ROOT.TCanvas()
#    first = True 
...
#        h_ht[name][stb][njb].Draw('same')
#    l.Draw()
#    c1.Print('/afs/hephy.at/user/s/schoefbeck/www/pngCMG/'+prefix+'_rCS_ht_'+name+'_'+nameAndCut(stb=None,htb=None,njetb=njb,btb=None, presel=presel)[0]+".png")
#
...
for name, c in [ ["TT", cTTJets]]:
  ...
  #      h_btb[name][stb][htb].GetYaxis().SetRangeUser(0, 1.2*h_btb[name][stb][htb].GetBinContent(h_btb[name][stb][htb].GetMaximumBin()))
      ...
      l.Draw()
      c1.Print('/afs/hephy.at/user/s/schoefbeck/www/pngCMG/'+prefix+'_rCS_nbtag_'+name+'_'+nameAndCut(stb,htb=htb,njetb=None, btb=None, presel=presel)[0]+".png")
