...
#python cmgPostProcessing.py --overwrite --manScaleFactor=1.0 --skim="HT500ST250diLep" --samples=TTJets_DiLepton_full
#python cmgPostProcessing.py --overwrite --manScaleFactor=1.0 --skim="HT500ST250semiLep" --samples=TTJets_SingleLeptonFromT_full
#python cmgPostProcessing.py --overwrite --manScaleFactor=1.0 --skim="HT500ST250semiLep" --samples=TTJets_SingleLeptonFromTbar_full
#python cmgPostProcessing.py --overwrite  --calcbtagweights --manScaleFactor=1.0 --skim="HT500ST250LHE_FullHadronic_inc" --samples=TTJets_NLO

python cmgPostProcessing.py --overwrite  --calcbtagweights --skim="HT500ST250" --samples=TTJets_DiLepton_full
