...
python cmgPostProcessing.py --overwrite --calcbtagweights --skim="HT350" --samples=ST_tchannel_antitop_4f_leptonDecays
python cmgPostProcessing.py --overwrite --calcbtagweights --skim="HT350" --samples=ST_tchannel_top_4f_leptonDecays
python cmgPostProcessing.py --overwrite --calcbtagweights --skim="HT350" --samples=ST_schannel_4f_leptonDecays
python cmgPostProcessing.py --overwrite --calcbtagweights --skim="HT350" --samples=ST_tW_top_5f_inclusiveDecays
