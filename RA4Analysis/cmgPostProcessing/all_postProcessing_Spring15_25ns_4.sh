...
python cmgPostProcessing.py --overwrite  --skim="HT500ST250"  --samples=ST_schannel_4f_leptonDecays
python cmgPostProcessing.py --overwrite  --skim="HT500ST250"  --samples=ST_tW_antitop_5f_inclusiveDecays
python cmgPostProcessing.py --overwrite  --skim="HT500ST250"  --samples=ST_tW_top_5f_inclusiveDecays
