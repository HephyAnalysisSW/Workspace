...
leptonID = "muIsPF[gLepInd]&&(muIsGlobal[gLepInd]||muIsTracker[gLepInd])&&muPt[gLepInd]>"+str(ptCut)+"&&abs(muEta[gLepInd])<2.1"\
          ...
          +"&&muRelIso[gLepInd]<0.2"
prefix = 'vetoMuIDPt15_NoRelIso_ttJetsCSA1450ns'
#prefix = 'vetoMuIDPt15'
...
#c.Draw('gLepInd>=0>>muPresEff','abs(gLepPdg)==13&&gLepPt>'+str(ptCut),'goff')
...
#for i in range(0, muPtPresEff.GetNbinsX()+1):
#  print muPtIDEff.GetBinContent(i), muPtPresEff.GetBinContent(i)
#  muPtIDEff.SetBinContent(i, muPtIDEff.GetBinContent(i)*muPtPresEff.GetBinContent(i))
...
#for i in range(0, muEtaPresEff.GetNbinsX()+1):
#  muEtaIDEff.SetBinContent(i, muEtaIDEff.GetBinContent(i)*muEtaPresEff.GetBinContent(i))
...
#for i in range(0, muPtEta2DPresEff.GetNbinsX()+1):
#  for j in range(0, muPtEta2DPresEff.GetNbinsX()+1):
#    muPtEta2DEff.SetBinContent(i,j, muPtEta2DEff.GetBinContent(i)*muPtEta2DPresEff.GetBinContent(i))
