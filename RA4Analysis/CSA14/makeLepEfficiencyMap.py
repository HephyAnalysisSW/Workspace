...
for relIso in [0.3]:
  ...
  c.Draw('gLepDR<0.4&&abs(1-muPt[gLepInd]/gLepPt)<0.9&&'+leptonID+':gLepPt>>muPtIDEff','abs(gLepPdg)==13&&gLepPt>'+str(ptCut)+'&&abs(gLepEta)<2.5&&gLepInd>=0'+"&&"+hadPresel+diLepSelection, 'goff')
  ...
  c.Draw('gLepDR<0.4&&abs(1-muPt[gLepInd]/gLepPt)<0.9&&'+leptonID+':gLepEta>>muEtaIDEff','abs(gLepPdg)==13&&gLepPt>'+str(ptCut)+'&&gLepInd>=0'+"&&"+hadPresel+diLepSelection, 'goff')
  ...
  c.Draw('gLepDR<0.4&&abs(1-muPt[gLepInd]/gLepPt)<0.9&&'+leptonID+':ngoodVertices>>munVtxIDEff','abs(gLepPdg)==13&&gLepPt>'+str(ptCut)+'&&abs(gLepEta)<2.5&&gLepInd>=0'+"&&"+hadPresel+diLepSelection, 'goff')
  ...
  c.Draw('gLepDR<0.4&&abs(1-muPt[gLepInd]/gLepPt)<0.9&&'+leptonID+':gLepEta:gLepPt>>muPtEta2DEff','abs(gLepPdg)==13&&gLepPt>'+str(ptCut)+'&&abs(gLepEta)<2.5&&gLepInd>=0'+"&&"+hadPresel+diLepSelection, 'goff')
