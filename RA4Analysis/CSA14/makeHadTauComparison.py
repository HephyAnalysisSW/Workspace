...
for htCut in [0]:
  for stCut in [0]:
    ...
    for nbtagsCut in [0,1,2]: 
      ...
      genSel= oneHadTau+'&&ht>'+str(htCut)+'&&nbtags=='+str(nbtagsCut)+'&&(njets==2||njets==3)&&'+stLep+'>'+str(stCut) 
      predSel = 'htPred>'+str(htCut)+'&&nbtags=='+str(nbtagsCut)+'&&(njetsPred==2||njetsPred==3)&&'+stLepPred+'>'+str(stCut)
      Path='/afs/hephy.at/user/e/easilar/www/hadronicTau/ht_'+str(htCut)+'_st_'+str(stCut)+'_njet_2or3_ntag_'+str(nbtagsCut)+'/' ##'+str(nbtagsCut)+'/'
