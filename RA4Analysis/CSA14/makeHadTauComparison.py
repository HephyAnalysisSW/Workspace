...
hMT.Draw('same')
c1.SetLogy()
c1.Print('/afs/hephy.at/user/s/schoefbeck/www/pngCSA14/compMT_hadTau.png')
...
hHT.Draw('same')
c1.SetLogy()
c1.Print('/afs/hephy.at/user/s/schoefbeck/www/pngCSA14/compHT_hadTau.png')
...
hNJet.Draw('same')
c1.SetLogy()
c1.Print('/afs/hephy.at/user/s/schoefbeck/www/pngCSA14/compNJet_hadTau.png')
