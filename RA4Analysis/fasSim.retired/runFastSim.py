...
while True:
  ...
  if not os.path.isfile(outFile):  
    ...
    sstring+="cmsRun /afs/hephy.at/scratch/s/schoefbeck/CMS/CMSSW_5_3_14/src/Workspace/RA4Analysis/fastSim/run_Hadronizer_SMS_Scans_2jets_Qcut44_TuneZ2star_8TeV_madgraph_tauola_cff_py_GEN_FASTSIM_HLT_PU.py"
