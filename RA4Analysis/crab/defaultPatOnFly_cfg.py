...
process.out = cms.OutputModule("PoolOutputModule",
     ...
     outputCommands = cms.untracked.vstring('drop *', 'keep *_*RA4Tupelizer*_*_*' , 'keep *_*EventCounter*_*_*', 'keep *_genParticles_*_SIM') 
)
...
process.RA4Tupelizer.addFullTauInfo = cms.untracked.bool(True)
process.RA4Tupelizer.addRA4AnalysisInfo = cms.untracked.bool(options.addRA4Info)
