...
path = '/afs/hephy.at/user/e/easilar/www/hadronicTau_cmg/fakeRate_Results/'
...
fname='CSA14_TTJet_tauToBfakeRate_cmg.pkl'
pickle.dump(fRate, file(path+fname,'w'))
print "Written",  path+fname

DrawNicePlot(fRate,'tau fake Rate','fake Rate','gen Tau Pt',path,'Loop_FakeRate_cmg.png')
