...
python cmgPostProcessing.py --leptonSelection=$1 --samples=SMS_T5qqqqWW_Gl1500_Chi800_LSP100  $2        &     
python cmgPostProcessing.py --leptonSelection=$1 --samples=SMS_T5qqqqWW_Gl1200_Chi1000_LSP800 $2        &
python cmgPostProcessing.py --leptonSelection=$1 --samples=SMS_T1tttt_2J_mGl1500_mLSP100 $2             &
python cmgPostProcessing.py --leptonSelection=$1 --samples=SMS_T1tttt_2J_mGl1200_mLSP800 $2             &
