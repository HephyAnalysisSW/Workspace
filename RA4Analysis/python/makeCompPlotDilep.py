...
def DrawClosure(plot1,plot2,plot3,plot4,plot1name,path):
  ...
  leg.AddEntry(plot1, "Predicted","l")
  leg.AddEntry(plot2, "Truth","l")
  leg.AddEntry(plot3, "1.1*(1-Eff) Pred","l")
  leg.AddEntry(plot4, "0.9*(1-Eff) Pred","l")
  leg.SetFillColor(0)
  leg.Draw()
  can.cd()
  ...
  Func.Draw('same')
  h_ratio.SetTitle("")
  h_ratio.GetYaxis().SetTitle("ratio Pred/Truth ")
