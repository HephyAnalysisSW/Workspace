...
#dir = '/data/easilar/cmgTuples/postProcessing_Run2016B_4fb_data/HT500LT250Skim/'
dir = '/data/dspitzbart/cmgTuples/postProcessing_Run2016BC_JECv6/HT500LT250Skim/'
...
single_mu_Run2016C = {\
"name" : "SingleMuon_Run2016C_PromptReco_v2_HT500ST250",
"bins" : [
...
single_ele_Run2016C = {\
"name" : "SingleElectron_Run2016C_PromptReco_v2_HT500ST250",
"bins" : [
"SingleElectron_Run2016C-PromptReco-v2",
],
'dir' : dir,
}
