...
if presel == "4j30":
  ...
  commoncf = "jet1pt>30&&jet3pt>30&&lepton_pt>20&&singleElectronic"
if presel == "pf-4j30":
...
#  MC_TTJETS.normalizeTo        = DATA
#  MC_TTJETS.add                = [MC_WJETS]
#  MC_WJETS.legendText          = "W + Jets"
#  MC_WJETS.style               = "f"
#  MC_WJETS.add                 = [MC_QCD]
#  MC_WJETS.color               = ROOT.kYellow
#  MC_WJETS.normalizeTo         = DATA
#  MC_WJETS.normalizeWhat       = MC_TTJETS
#  MC_QCD.color                 = myBlue
#  MC_QCD.legendText            = "QCD"
#  MC_QCD.style                 = "f"
##  MC_QCD.floating              = True
##  MC_WJETS.scale               = 2.709 #no MET cut
#  MC_QCD.add                   = [MC_STOP]
#  MC_QCD.normalizeTo           = DATA
#  MC_QCD.normalizeWhat         = MC_TTJETS
#  MC_STOP.legendText           = "single Top"
#  MC_STOP.style                = "f"
#  MC_STOP.add                  = [MC_ZJETS]
#  MC_STOP.color                = ROOT.kOrange + 4
#  MC_STOP.normalizeTo          = DATA
#  MC_STOP.normalizeWhat        = MC_TTJETS
#  MC_ZJETS.legendText          = "DY + Jets"
#  MC_ZJETS.style               = "f"
#  MC_ZJETS.color               = ROOT.kGreen + 3
#  MC_ZJETS.normalizeTo         = DATA
#  MC_ZJETS.normalizeWhat       = MC_TTJETS
#
...
#  nhistos = len(res)
#  for var in res:
#    var.legendCoordinates=[0.75,0.95 - 0.05*nhistos,.98,.95]
#  res.append(DATA)
#  return res

#lepton_relIso_stack               = getStack(":lepton_relIso;relIso;Number of Events",[25,0,0.5], commoncf)
#allStacks.append(lepton_relIso_stack)
#lepton_relIso2_stack               = getStack(":lepton_relIso;relIso;Number of Events",[30,0,1.5], commoncf)
#allStacks.append(lepton_relIso2_stack)
#
#tp_zmass_0j_stack          = getStack(":tp_zmass;m_{Z};Number of Events",[26,77,103], "kinMetSig<2.5&&ngoodElectrons>0&&ngoodMuons==0", False)
#allStacks.append(tp_zmass_0j_stack)
#tp_zmass_1j_stack          = getStack(":tp_zmass;m_{Z};Number of Events",[26,77,103], "kinMetSig<2.5&&ngoodElectrons>0&&ngoodMuons==0&&jet0pt>30", False)
#allStacks.append(tp_zmass_1j_stack)
#tp_zmass_2j_stack          = getStack(":tp_zmass;m_{Z};Number of Events",[26,77,103], "kinMetSig<2.5&&ngoodElectrons>0&&ngoodMuons==0&&jet1pt>30", False)
#allStacks.append(tp_zmass_2j_stack)
#tp_zmass_3j_stack          = getStack(":tp_zmass;m_{Z};Number of Events",[26,77,103], "kinMetSig<2.5&&ngoodElectrons>0&&ngoodMuons==0&&jet2pt>30", False)
#allStacks.append(tp_zmass_3j_stack)
#tp_zmass_4j_stack          = getStack(":tp_zmass;m_{Z};Number of Events",[26,77,103], "kinMetSig<2.5&&ngoodElectrons>0&&ngoodMuons==0&&jet3pt>30", False)
#allStacks.append(tp_zmass_4j_stack)

#tp_p_relIso_0j_stack               = getStack(":tp_p_relIso;relIso;Number of Events",[30,0,1.5], "kinMetSig<2.5&&ngoodElectrons>0&&ngoodMuons==0&&abs(tp_zmass-91.2)<15.")
#allStacks.append(tp_p_relIso_0j_stack)
#tp_p_relIso_1j_stack               = getStack(":tp_p_relIso;relIso;Number of Events",[30,0,1.5], "kinMetSig<2.5&&ngoodElectrons>0&&ngoodMuons==0&&abs(tp_zmass-91.2)<15.&&jet0pt>30")
#allStacks.append(tp_p_relIso_1j_stack)
#tp_p_relIso_2j_stack               = getStack(":tp_p_relIso;relIso;Number of Events",[30,0,1.5], "kinMetSig<2.5&&ngoodElectrons>0&&ngoodMuons==0&&abs(tp_zmass-91.2)<15.&&jet1pt>30")
#allStacks.append(tp_p_relIso_2j_stack)
#tp_p_relIso_3j_stack               = getStack(":tp_p_relIso;relIso;Number of Events",[30,0,1.5], "kinMetSig<2.5&&ngoodElectrons>0&&ngoodMuons==0&&abs(tp_zmass-91.2)<15.&&jet2pt>30")
#allStacks.append(tp_p_relIso_3j_stack)
#tp_p_relIso_4j_stack               = getStack(":tp_p_relIso;relIso;Number of Events",[30,0,1.5], "kinMetSig<2.5&&ngoodElectrons>0&&ngoodMuons==0&&abs(tp_zmass-91.2)<15.&&jet3pt>30")
#allStacks.append(tp_p_relIso_4j_stack)

relIso_control_kMs_1_ht_300_350_stack               = getStack(":lepton_relIso;relIso;Number of Events",[30,0,1.5], "ngoodElectrons==1&&ngoodMuons==0&&kinMetSig<1.&&jet3pt>30&&300<ht&&ht<350")
allStacks.append(relIso_control_kMs_1_ht_300_350_stack)
relIso_control_kMs_1_ht_200_300_stack               = getStack(":lepton_relIso;relIso;Number of Events",[30,0,1.5], "ngoodElectrons==1&&ngoodMuons==0&&kinMetSig<1.&&jet3pt>30&&200<ht&&ht<300")
allStacks.append(relIso_control_kMs_1_ht_200_300_stack)
relIso_control_kMs_1_ht_200_250_stack               = getStack(":lepton_relIso;relIso;Number of Events",[30,0,1.5], "ngoodElectrons==1&&ngoodMuons==0&&kinMetSig<1.&&jet3pt>30&&200<ht&&ht<250")
allStacks.append(relIso_control_kMs_1_ht_200_250_stack)
relIso_control_kMs_1_ht_150_200_stack               = getStack(":lepton_relIso;relIso;Number of Events",[30,0,1.5], "ngoodElectrons==1&&ngoodMuons==0&&kinMetSig<1.&&jet3pt>30&&150<ht&&ht<200")
allStacks.append(relIso_control_kMs_1_ht_150_200_stack)
relIso_control_kMs_1_ht_150_250_stack               = getStack(":lepton_relIso;relIso;Number of Events",[30,0,1.5], "ngoodElectrons==1&&ngoodMuons==0&&kinMetSig<1.&&jet3pt>30&&150<ht&&ht<250")
allStacks.append(relIso_control_kMs_1_ht_150_250_stack)


relIso_control_kMs_05_ht_300_350_stack               = getStack(":lepton_relIso;relIso;Number of Events",[30,0,1.5], "ngoodElectrons==1&&ngoodMuons==0&&kinMetSig<0.5&&jet3pt>30&&300<ht&&ht<350")
allStacks.append(relIso_control_kMs_05_ht_300_350_stack)
relIso_control_kMs_05_ht_200_300_stack               = getStack(":lepton_relIso;relIso;Number of Events",[30,0,1.5], "ngoodElectrons==1&&ngoodMuons==0&&kinMetSig<0.5&&jet3pt>30&&200<ht&&ht<300")
allStacks.append(relIso_control_kMs_05_ht_200_300_stack)
relIso_control_kMs_05_ht_200_250_stack               = getStack(":lepton_relIso;relIso;Number of Events",[30,0,1.5], "ngoodElectrons==1&&ngoodMuons==0&&kinMetSig<0.5&&jet3pt>30&&200<ht&&ht<250")
allStacks.append(relIso_control_kMs_05_ht_200_250_stack)
relIso_control_kMs_05_ht_150_200_stack               = getStack(":lepton_relIso;relIso;Number of Events",[30,0,1.5], "ngoodElectrons==1&&ngoodMuons==0&&kinMetSig<0.5&&jet3pt>30&&150<ht&&ht<200")
allStacks.append(relIso_control_kMs_05_ht_150_200_stack)
relIso_control_kMs_05_ht_150_250_stack               = getStack(":lepton_relIso;relIso;Number of Events",[30,0,1.5], "ngoodElectrons==1&&ngoodMuons==0&&kinMetSig<0.5&&jet3pt>30&&150<ht&&ht<250")
allStacks.append(relIso_control_kMs_05_ht_150_250_stack)

relIso_A_stack               = getStack(":lepton_relIso;relIso;Number of Events",[30,0,1.5], "ngoodElectrons==1&&ngoodMuons==0&&kinMetSig>2.5&&kinMetSig<5.0&&jet3pt>30&&ht>330&&ht<410")
allStacks.append(relIso_A_stack)
relIso_B_stack               = getStack(":lepton_relIso;relIso;Number of Events",[30,0,1.5], "ngoodElectrons==1&&ngoodMuons==0&&kinMetSig>5&&jet3pt>30&&ht>330&&ht<410")
allStacks.append(relIso_B_stack)
relIso_C_stack               = getStack(":lepton_relIso;relIso;Number of Events",[30,0,1.5], "ngoodElectrons==1&&ngoodMuons==0&&kinMetSig>2.5&&kinMetSig<5.0&&jet3pt>30&&ht>410")
allStacks.append(relIso_C_stack)
relIso_D_stack               = getStack(":lepton_relIso;relIso;Number of Events",[30,0,1.5], "ngoodElectrons==1&&ngoodMuons==0&&kinMetSig>5.0&&jet3pt>30&&ht>410")
allStacks.append(relIso_D_stack)


relIso_signal_stack               = getStack(":lepton_relIso;relIso;Number of Events",[30,0,1.5], "ngoodElectrons==1&&ngoodMuons==0&&kinMetSig>2.5&&jet3pt>30&&ht>300")
...
def getYieldLowRelIso(thisvar):
  h = thisvar.data_histo
  print  "Integrating up to Bin",h.FindBin(0.07)-1,h.GetBinLowEdge(h.FindBin(0.07))
  return h.Integral(0, h.FindBin(0.07)-1)
...
control_lowrelIso  = getYieldLowRelIso(relIso_control_kMs_1_ht_300_350_stack[0])
control_highrelIso = getYieldHighRelIso(relIso_control_kMs_1_ht_300_350_stack[0])
...
control_lowrelIso  = getYieldLowRelIso(relIso_control_kMs_05_ht_300_350_stack[-1])
control_highrelIso = getYieldHighRelIso(relIso_control_kMs_05_ht_300_350_stack[-1])
control_ratio = control_lowrelIso/control_highrelIso
