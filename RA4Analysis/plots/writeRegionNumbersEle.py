...
if presel == "pf-ex3j30":
  chainstring = "pfRA4Analyzer/Events"
  commoncf = "jet1pt>30&&jet2pt>30&&(!(jet3pt>30))&&lepton_pt>20&&singleElectronic"
if presel == "pf-4j30-l25":
  chainstring = "pfRA4Analyzer/Events"
  commoncf = "jet1pt>30&&jet3pt>30&&lepton_pt>25&&singleElectronic"
if presel == "pf-ex3j30-l25":
  chainstring = "pfRA4Analyzer/Events"
  commoncf = "jet1pt>30&&jet2pt>30&&(!(jet3pt>30))&&lepton_pt>25&&singleElectronic"
if presel == "120_80_50":
  chainstring = "pfRA4Analyzer/Events"
...
#  filepostfix = var1+"_"+str(var1_cut1)+"_"+str(var1_cut2)+"_"+str(var1_cut3)+"_"+var2+"_"+str(var2_cut1)+"_"+str(var2_cut2)+"_"+str(var2_cut3)
...
writeCutRegions(2.5, 3., 0., 300, 650, 650)
