...
#preprefix = "kMs2.5ht300-oldRA4-Mu"
additionalCut = ""
preprefix = "oldRA4-Mu"
signalNumbers = []
...
if presel == "3j50":
  chainstring = "pfRA4Analyzer/Events"
  commoncf = "jet2pt>50&&lepton_pt>15&&singleMuonic"
if presel == "2j80+1j50":
  chainstring = "pfRA4Analyzer/Events"
  commoncf = "jet1pt>80&&jet2pt>50&&lepton_pt>15&&singleMuonic"
if presel == "2j80+2j50":
  chainstring = "pfRA4Analyzer/Events"
  commoncf = "jet1pt>80&&jet3pt>50&&lepton_pt>15&&singleMuonic"
if presel == "120_80_50":
  chainstring = "pfRA4Analyzer/Events"
  commoncf = "jet0pt>120&&jet1pt>80&&jet2pt>50&&lepton_pt>15&&singleMuonic"
