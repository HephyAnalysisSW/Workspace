...
can.Print('/afs/hephy.at/user/'+username[0]+'/'+username+'/www/data/Run2016B/2571pb/syst_uncertainties/diLepSys_ICHEP_v3.png')
can.Print('/afs/hephy.at/user/'+username[0]+'/'+username+'/www/data/Run2016B/2571pb/syst_uncertainties/diLepSys_ICHEP_v3.root')
can.Print('/afs/hephy.at/user/'+username[0]+'/'+username+'/www/data/Run2016B/2571pb/syst_uncertainties/diLepSys_ICHEP_v3.pdf')
