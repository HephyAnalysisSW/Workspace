...
if testRun:
  ...
  predictionName = 'testRun'+prefix
  printDir    = '/afs/hephy.at/user/'+username[0]+'/'+username+'/www/Results'+year+'/templateFit_'+predictionName+'_'+lumistr+'/'
  pickleDir   = '/afs/hephy.at/user/'+username[0]+'/'+username+'/www/Results'+year+'/Prediction_'+predictionName+'_'+lumistr+'/'
  templateDir = '/afs/hephy.at/user/'+username[0]+'/'+username+'/www/Results'+year+'/btagTemplates_'+predictionName+'_'+templateLumistr+'/'
