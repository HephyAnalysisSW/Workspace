...
Bkg = [
       {'name':'WJetsToLNu_HT100to200', 'sample':WJetsToLNu_HT100to200, 'legendName':'W HT100-200', 'color':ROOT.kGreen+3, 'merge':'EWK'},
       {'name':'WJetsToLNu_HT200to400', 'sample':WJetsToLNu_HT200to400, 'legendName':'W HT200-400', 'color':ROOT.kGreen, 'merge':'EWK'},
       {'name':'WJetsToLNu_HT400to600', 'sample':WJetsToLNu_HT400to600, 'legendName':'W HT400-600', 'color':ROOT.kGreen-3, 'merge':'EWK'},
       {'name':'WJetsToLNu_HT600to800', 'sample':WJetsToLNu_HT600to800, 'legendName':'W HT600-800', 'color':ROOT.kGreen-7, 'merge':'EWK'},
...
#                                                          wboson['name']+'_cosTheta_ht'+str(htb[0])+'-'+str(htb[1])+'_ptW'+str(ptw[0])+'-'+str(ptw[1])+'_absEtaW'+str(eta[0])+'-'+str(eta[1]),200,-1,1)  
    ...
    for sample in Bkg:
      cutname = nameAndCut(None, None, None, btb=None, presel=wboson['cut'])[0]
      cut = '('+wboson['cut']+')'
