...
for key in effs.keys():
  ...
  can.Print('/afs/hephy.at/user/d/dspitzbart/www/Spring15/btagEfficiency/'+key+'_Spring15.png')
  can.Print('/afs/hephy.at/user/d/dspitzbart/www/Spring15/btagEfficiency/'+key+'_Spring15.pdf')
  can.Print('/afs/hephy.at/user/d/dspitzbart/www/Spring15/btagEfficiency/'+key+'_Spring15.root')
