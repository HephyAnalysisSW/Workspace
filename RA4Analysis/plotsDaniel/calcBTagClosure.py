...
b_upDir       = 'Prediction_Spring16_templates_SR2016_v2_lep_MC_SF_b_Up_7p62/'
b_downDir     = 'Prediction_Spring16_templates_SR2016_v2_lep_MC_SF_b_Down_7p62/'
light_upDir   = 'Prediction_Spring16_templates_SR2016_v2_lep_MC_SF_light_Up_7p62/'
light_downDir = 'Prediction_Spring16_templates_SR2016_v2_lep_MC_SF_light_Down_7p62/'
nominalDir    = 'Prediction_Spring16_templates_SR2016_v2_lep_MC_SF_7p62/'
...
if savePkl:
  pickle.dump(b_dict, file(saveDir+'btagErr_pkl','w'))
  pickle.dump(l_dict, file(saveDir+'mistagErr_pkl','w'))
