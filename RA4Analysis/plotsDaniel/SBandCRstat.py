  ...
  for stb in sorted(signalRegions[srNJet]):
    ...
    for htb in sorted(signalRegions[srNJet][stb]):
      ...
      for nc,charge in charges:
        ...
        stats[srNJet][stb][htb][nc]['CR']['data'] =        getYieldFromChain(cData,  cutString=CR+'&&deltaPhi_Wl<'+str(deltaPhi))
        stats[srNJet][stb][htb][nc]['CR']['data_err'] =    sqrt(getYieldFromChain(cData,  cutString=CR+'&&deltaPhi_Wl<'+str(deltaPhi)))
        stats[srNJet][stb][htb][nc]['CR']['data1b'] =        getYieldFromChain(cData,  cutString=CR1b+'&&deltaPhi_Wl<'+str(deltaPhi))
        stats[srNJet][stb][htb][nc]['CR']['data1b_err'] =    sqrt(getYieldFromChain(cData,  cutString=CR1b+'&&deltaPhi_Wl<'+str(deltaPhi)))
        stats[srNJet][stb][htb][nc]['CR']['data2b'] =        getYieldFromChain(cData,  cutString=CR2b+'&&deltaPhi_Wl<'+str(deltaPhi))
        stats[srNJet][stb][htb][nc]['CR']['data2b_err'] =    sqrt(getYieldFromChain(cData,  cutString=CR2b+'&&deltaPhi_Wl<'+str(deltaPhi)))
        ...
        stats[srNJet][stb][htb][nc]['SBTT']['highDPhi']['data'] =        getYieldFromChain(cData,  cutString=SBTT+'&&deltaPhi_Wl>='+str(deltaPhi))
        stats[srNJet][stb][htb][nc]['SBTT']['highDPhi']['data_err'] =    sqrt(getYieldFromChain(cData,  cutString=SBTT+'&&deltaPhi_Wl>='+str(deltaPhi)))
        ...
        stats[srNJet][stb][htb][nc]['SBTT']['lowDPhi']['data'] =        getYieldFromChain(cData,  cutString=SBTT+'&&deltaPhi_Wl<'+str(deltaPhi))
        stats[srNJet][stb][htb][nc]['SBTT']['lowDPhi']['data_err'] =    sqrt(getYieldFromChain(cData,  cutString=SBTT+'&&deltaPhi_Wl<'+str(deltaPhi)))
        ...
        stats[srNJet][stb][htb][nc]['SBW']['highDPhi']['data'] =        getYieldFromChain(cData,  cutString=SBW+'&&deltaPhi_Wl>='+str(deltaPhi))
        stats[srNJet][stb][htb][nc]['SBW']['highDPhi']['data_err'] =    sqrt(getYieldFromChain(cData,  cutString=SBW+'&&deltaPhi_Wl>='+str(deltaPhi)))
        ...
        stats[srNJet][stb][htb][nc]['SBW']['lowDPhi']['data'] =        getYieldFromChain(cData,  cutString=SBW+'&&deltaPhi_Wl<'+str(deltaPhi))
        stats[srNJet][stb][htb][nc]['SBW']['lowDPhi']['data_err'] =    sqrt(getYieldFromChain(cData,  cutString=SBW+'&&deltaPhi_Wl<'+str(deltaPhi)))
