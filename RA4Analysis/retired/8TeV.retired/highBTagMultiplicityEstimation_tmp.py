...
#calculate mean Spill factors for interesting regions
interestingRegions = [[[400, 2500], [150, 2500]], [[400, 2500], [250, 2500]], [[400, 2500], [350, 2500]], [[750, 2500], [250, 2500]], [[1000, 2500], [250, 2500]] ]
SpF_rw = {}
for htb2, metb2 in interestingRegions:
  print htb2, metb2
  SpF_rw[htb2[0]] = {}
  SpF_rw[htb2[0]][metb2[0]] = {}
  for htb in htbins:
    if htb[0]>=htb2[0]:
      for metb in metbins:
        if metb[0]>=metb2[0]:
          print htb, metb,"is in",htb2, metb2
          for btk in SpF[tuple(htb)][tuple(metb)][-1].keys():
            SpF_rw[htb2[0]][metb2[0]][btk] = {}
            for sfk in SpF[tuple(htb)][tuple(metb)][-1][btk].keys():
              SpF_rw[htb2[0]][metb2[0]][btk][sfk] = {}
              print "Add ",btk,sfk, binnedYield[btb][mode][tuple(htb)][tuple(metb)]['MC_sumW'], SpF[tuple(htb)][tuple(metb)][-1][btk][sfk]
...
#def getMetRatioFromWK(htb, contBin, sigBin, retMetShape=False):
#  btb = "bt3"
...
#  print "mode",sysmode,inputDir[sysmode]
...
#    yields      [btb][mode] = {}
#    for htb, metb in interestingRegions:
#      print htb, metb
...
#
#      mc_2b =  getPredictionFromSamplingDirectory(goodDirectories['MC_central'], btb = 2, htb = htb, metb = metb, metvar = "met")
#      print "MC  :", htb, metb, 'btb2',mc_2b['predictedYield'], mc_2b['dataYield']['res']
#      data_2b =  getPredictionFromSamplingDirectory(goodDirectories['data_central'], btb = 2, htb = htb, metb = metb, metvar = "met")
#      print "Data:",htb, metb, 'btb2', data_2b['predictedYield'], data_2b['dataYield']['res']
...
#        MetRatioUncorr_MC = getMetRatioFromWK(htb, metControlBin, metb) 
