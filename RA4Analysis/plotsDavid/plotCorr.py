...
allSignals=[
            ...
            {'name':'T5qqqq1000-800-700', 'sample':T5qqqqWW_mGo1000_mCh800_mChi700[lepSel], 'weight':'weight', 'color':ROOT.kBlue},
...
preprefix = 'singleMuonic_0b_ht750_st350_nj5_dPhi1'
...
#          h_ratio[sig['name']][var['name']].GetXaxis().SetLabelOffset(0.04)
      ...
      for sample in allBkg + allSignals:
        corrCanvas = ROOT.TCanvas('Correlation '+sample['name'],'Correlation '+sample['name'],1200,1200)
