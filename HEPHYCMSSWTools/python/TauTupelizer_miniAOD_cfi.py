...
TauTupelizer = cms.EDProducer ( "TauTupelizer",
    ...
    tauIDs = cms.untracked.VPSet(
        ...
        cms.untracked.PSet(accessTag = cms.untracked.string("againstMuonLoose"),
                           storeTag = cms.untracked.string("AgainstMuonLoose")),
        cms.untracked.PSet(accessTag = cms.untracked.string("againstMuonLooseMVA"),
                           storeTag = cms.untracked.string("AgainstMuonLooseMVA")),
        cms.untracked.PSet(accessTag = cms.untracked.string("byCombinedIsolationDeltaBetaCorrRaw3Hits"),
                           storeTag = cms.untracked.string("ByCombinedIsolationDeltaBetaCorrRaw3Hits")),
