...
parser.add_argument("--iso", dest="iso",  help="Isolation", type=str, default="") #hybIso03, hybIso04
   ...
   if scan == "standard": 
      ...
      for sample in samples:
         ...
         for ID in IDs:
            for plot in plots:
               for zoom in zooms: 
                  if iso: os.system("python -b ../eleIDeffs.py --mvaWPs 1 --sample " + sample + " --id " + ID + " --plot " + plot + " --iso " + iso + " --lowPt " + str(lowPt) + " --zoom " + str(zoom))
                  else: os.system("python -b ../eleIDeffs.py --mvaWPs 1 --sample " + sample + " --id " + ID + " --plot " + plot + " --lowPt " + str(lowPt) + " --zoom " + str(zoom))
         ...
         for plot in plots:
            if not lowPt: 
               ...
               for var in variables:
                  if iso:
                     os.system("python -b ../eleIDeffs.py --zoom 0 --sample " + sample + " --removedCut " + var + " --plot " + plot + " --iso " + iso)
                     os.system("python -b ../eleIDeffs.py --zoom 1 --sample " + sample + " --removedCut " + var + " --plot " + plot + " --iso " + iso)
                  else:
               ...
               for var in variables:
                  if iso: os.system("python -b ../eleIDeffs.py --zoom 0 --lowPt 1 --sample " + sample + " --removedCut " + var + " --plot " + plot + " --iso " + iso)
                  else: os.system("python -b ../eleIDeffs.py --zoom 0 --lowPt 1 --sample " + sample + " --removedCut " + var + " --plot " + plot)
               #outfile.close()
