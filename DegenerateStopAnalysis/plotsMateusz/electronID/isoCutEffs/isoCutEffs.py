...
for i,plot in enumerate(sorted(total.keys())):
   ...
   elif plot == "misID": effs[plot]['Veto'].SetTitle("MisID Efficiency of " + isolation + " Isolation Cut (" + inputSample + " Sample) ; Generated Electron p_{T} / GeV ; Efficiency")
   elif plot == "misID2": effs[plot]['Veto'].SetTitle("MisID2 Efficiency of " + isolation + " Isolation Cut (" + inputSample + " Sample) ; Generated Electron p_{T} / GeV ; Efficiency")
