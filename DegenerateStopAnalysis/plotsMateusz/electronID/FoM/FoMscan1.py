...
if doPlots or doCutFlow:
   for sel in selections1:
         os.system("python -b eleIdFoM.py --ID " + ID + " --removedCut " + removedCut + " --WP None --selection " + sel + " --doPlots " + str(doPlots) + " --doCutFlow " + str(doCutFlow) + " --iso " + iso) 
   
   for sel in selections2:
      for iWP in WPs:
         os.system("python -b eleIdFoM.py --ID " + ID + " --removedCut " + removedCut + " --WP " + iWP + " --selection " + sel + " --doPlots " + str(doPlots) + " --doCutFlow " + str(doCutFlow) + " --iso " + iso) 

if doLimits or doYields:
   for iWP in WPs:
      os.system("python -b eleIdLimits.py --ID " + ID + " --removedCut " + removedCut + " --WP " + iWP + " --doLimits " + str(doLimits) + " --doYields " + str(doYields) + " --iso " + iso)
