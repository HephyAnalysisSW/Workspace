...
#Write to file
if save == 1:
   if mvaWPs == 0: savedir = "/afs/hephy.at/user/m/mzarucki/www/plots/electronReconstruction/electronID/iso/" + isolation + "/misID2" #web address: http://www.hephy.at/user/mzarucki/plots/electronReconstruction/electronIdEfficiency
   elif mvaWPs == 1: savedir = "/afs/hephy.at/user/m/mzarucki/www/plots/electronReconstruction/electronID/iso/" + isolation + "/misID2/withMva"
   ...
   #Save to Web
   c1.SaveAs(savedir + "/eleMisID2_iso_" + inputSample + z + ".png")
   c1.SaveAs(savedir + "/root/eleMisID2_iso_" + inputSample + z + ".root")
   c1.SaveAs(savedir + "/pdf/eleMisID2_iso_" + inputSample + z + ".pdf")
