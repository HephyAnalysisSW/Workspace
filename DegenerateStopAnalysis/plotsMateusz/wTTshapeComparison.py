...
parser.add_argument("--scale", dest = "scale",  help = "Scale", type = int, default = 1)
...
plots_ =  getPlots(samples, plotsDict, [cuts_weights, region + ptInc + prompt], samplesList, plotList = ['lepPt'], addOverFlowBin='both')
plots =  drawPlots(samples, plotsDict, [cuts_weights, region + ptInc + prompt], samplesList, plotList = ['lepPt'], plotLimits = [1, 100], denoms = ["tt_1l"], noms = ["w"], fom = "RATIO", fomLimits = [0,1.8], plotMin = 1, normalize = False, save = False)
