...
#Canvas 1: MET 1
c1 = ROOT.TCanvas("c1", "Optimisation")
...
gr1.SetTitle("Total Filter Efficiency at Both Reco Cut Values vs Both Generator Cuts")
...
c1.Update()
#pad1->Update();
c1.SaveAs(path + "efficiencyMaps/total3D/totalEfficiency1.root")
c1.SaveAs(path + "efficiencyMaps/total3D/totalEfficiency1.png")
c1.SaveAs(path + "efficiencyMaps/total3D/totalEfficiency1.pdf")
