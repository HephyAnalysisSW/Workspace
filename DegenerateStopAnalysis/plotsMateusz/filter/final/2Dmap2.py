...
'gMET' : 140, #generated quantity cuts
'gISR' : 0,
'gEta' : 90
})
...
c1.SaveAs(path + "%s_%s/2DmapROI2_90eta_%s_%s.root"%(str(cuts['gMET']), str(cuts['gISR']), str(cuts['gMET']), str(cuts['gISR'])))
c1.SaveAs(path + "%s_%s/2DmapROI2_90eta_%s_%s.png"%(str(cuts['gMET']), str(cuts['gISR']), str(cuts['gMET']), str(cuts['gISR'])))
c1.SaveAs(path + "%s_%s/2DmapROI2_90eta_%s_%s.pdf"%(str(cuts['gMET']), str(cuts['gISR']), str(cuts['gMET']), str(cuts['gISR'])))
