...
def main(gMETcut, gISRcut):
   ...
   **********************************************************************************************************************************\n"
   ...
   #Efficiency and Reduction Factor Calculation 
   var = "Max$(GenJet_pt*(abs(GenJet_eta)<" + str(cuts['Eta']) + "))" #Leading JET (highest pT) with eta < 2.4 
   ...
   #Write to file
   savedir = "/afs/hephy.at/user/m/mzarucki/www/plots/filter/ROI/filter_%s_%s"%(str(cuts["gMET"]),str(cuts["gISR"])) #web directory http://www.hephy.at/user/mzarucki/plots/filter/
