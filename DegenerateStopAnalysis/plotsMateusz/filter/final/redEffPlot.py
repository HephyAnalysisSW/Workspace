...
c1.SaveAs(path + "reductionEfficiency/redEffMET1plot.root")
c1.SaveAs(path + "reductionEfficiency/redEffMET1plot.png")
c1.SaveAs(path + "reductionEfficiency/redEffMET1plot.pdf")

c2.SaveAs(path + "reductionEfficiency/redEffMET2plot.root")
c2.SaveAs(path + "reductionEfficiency/redEffMET2plot.png")
c2.SaveAs(path + "reductionEfficiency/redEffMET2plot.pdf")

c3.SaveAs(path + "reductionEfficiency/redEffISR1plot.root")
c3.SaveAs(path + "reductionEfficiency/redEffISR1plot.png")
c3.SaveAs(path + "reductionEfficiency/redEffISR1plot.pdf")

c4.SaveAs(path + "reductionEfficiency/redEffISR2plot.root")
c4.SaveAs(path + "reductionEfficiency/redEffISR2plot.png")
c4.SaveAs(path + "reductionEfficiency/redEffISR2plot.pdf")
