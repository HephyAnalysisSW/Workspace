...
var = "met_genPt" #or met_genPt
c1.cd(1)
h1 = drawhist(T2DegSample, var, genSel2)
h1.SetName("h1")
h1.SetTitle("Reconstructed MET Filter Effect on Generated MET p_{T}")
...
h1.SetLineWidth(4)
l1 = makeLegend()
l1.AddEntry("h1", "Generated MET (no generator cuts)", "F")

h2 = drawhist(T2DegSample, var, preSel2 + "&&" + genSel2)
h2.SetName("h2")
h2.Draw("same")
h2.SetFillColor(0)
...
h2.SetLineWidth(4)
l1.AddEntry("h2", "Generated MET (with generator cuts)", "F")
l1.Draw()
...
metTurnon1.SetTitle("MET Inverse Turnon Plot ; Generated Missing Transverse Energy #slash{E}_{T} / GeV ; Counts")
...
var = "Max$(genJet_pt*(abs(genJet_eta)<" + str(cuts['gEta']) + "))" #Leading JET pt with eta < 2.4 #"Jet_pt" "GenJet_pt"
c2.cd(1)
h3 = drawhist(T2DegSample, var, genSel1)
h3.SetName("h3")
h3.SetTitle("ISR Jet p_{T} Filter Effect on Generated ISR Jet p_{T}")
...
h3.SetLineWidth(4)
l2 = makeLegend()
l2.AddEntry("h3", "Generated ISR Jet p_{T} (no generator cuts)", "F")

h4 = drawhist(T2DegSample, var, preSel1 + "&&" + genSel1)
h4.SetName("h4")
h4.Draw("same")
h4.SetFillColor(0)
...
h4.SetLineWidth(4)
l2.AddEntry("h4", "Generated ISR Jet p_{T} (with generator cuts)", "F")
l2.Draw()
...
jetTurnon1.SetTitle("ISR Jet p_{T} Inverse Turnon Plot ; ISR Jet p_{T} / GeV ; Counts")
...
var = "met_genPt" #or met_genPt
c3.cd(1)
h1.SetTitle("MET & ISR Jet p_{T} Filter Effect on Generated MET p_{T}")
h1.Draw()
#h3.SetFillColor(ROOT.kRed+1)
#h3.SetLineColor(ROOT.kBlack)
#h3.SetLineWidth(4)
l3 = makeLegend()
l3.AddEntry("h1", "Generated MET (no generator cuts)", "F")

h5 = drawhist(T2DegSample, var, preSel2 + "&&" + genSel1 + "&&" + genSel2)
h5.SetName("h5")
h5.Draw("same")
h5.SetFillColor(0)
...
h5.SetLineWidth(4)
l3.AddEntry("h5", "Generated MET (with both generator cuts)", "F")
l3.Draw()
...
metTurnon2.SetTitle("MET Inverse Turnon Plot ; Missing Transverse Energy #slash{E}_{T} / GeV ; Counts")
...
var = "Max$(genJet_pt*(abs(genJet_eta)<" + str(cuts['gEta']) + "))" #Leading JET pt with eta < 2.4 #"Jet_pt" "GenJet_pt"
c4.cd(1)
h3.SetTitle("ISR Jet p_{T} & MET Filter Effect on Generated ISR Jet p_{T}")
h3.Draw()
#h3.SetFillColor(ROOT.kRed+1)
#h3.SetLineColor(ROOT.kBlack)
#h3.SetLineWidth(4)
l4 = makeLegend()
l4.AddEntry("h3", "Generated ISR Jet p_{T} (no generator cuts)", "F")

h6 = drawhist(T2DegSample, var, preSel1 + "&&" + genSel2 + "&&" + genSel1)
h6.SetName("h6")
h6.Draw("same")
h6.SetFillColor(0)
...
h6.SetLineWidth(4)
l4.AddEntry("h6", "Generated ISR Jet p_{T} (with both generator cuts)", "F")
l4.Draw()
...
jetTurnon2.SetTitle("ISR Jet p_{T} Inverse Turnon Plot ; ISR Jet p_{T} / GeV ; Counts")
...
c1.SaveAs("/afs/cern.ch/work/m/mzarucki/plots/filter/invMET_%s_%s.png"%(str(cuts['gMET']),str(cuts['gISR'])))
c2.SaveAs("/afs/cern.ch/work/m/mzarucki/plots/filter/invJET_%s_%s.png"%(str(cuts['gMET']),str(cuts['gISR'])))
c3.SaveAs("/afs/cern.ch/work/m/mzarucki/plots/filter/invMET2_%s_%s.png"%(str(cuts['gMET']),str(cuts['gISR'])))
c4.SaveAs("/afs/cern.ch/work/m/mzarucki/plots/filter/invJET2_%s_%s.png"%(str(cuts['gMET']),str(cuts['gISR'])))
