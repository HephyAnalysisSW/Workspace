...
gr1 = ROOT.TGraph(len(redFactor1), np.array(effReco1, 'float64'), np.array(redFactor1, 'float64')) #graph object with error bars using arrays of data
gr1.SetTitle("MET 1: Reduction Factor vs Filter Efficiency at Reco Cut (200 GeV)")
 
gr1.SetMarkerColor(ROOT.kBlue)
gr1.SetMarkerStyle(ROOT.kFullCircle)
gr1.SetMarkerSize(0.5)
gr1.GetXaxis().SetTitle("Filter Efficiency at Reco Cut Value")
gr1.GetXaxis().CenterTitle()
gr1.GetYaxis().SetTitle("Reduction Factor")
...
gr2 = ROOT.TGraph(len(redFactor2), np.array(effReco2, 'float64'), np.array(redFactor2, 'float64')) #graph object with error bars using arrays of data
gr2.SetTitle("MET 2: Reduction Factor vs Filter Efficiency at Reco Cut (200 GeV)")

gr2.SetMarkerColor(ROOT.kBlue)
gr2.SetMarkerStyle(ROOT.kFullCircle)
gr2.SetMarkerSize(0.5)
gr2.GetXaxis().SetTitle("Filter Efficiency at Reco Cut Value")
gr2.GetXaxis().CenterTitle()
gr2.GetYaxis().SetTitle("Reduction Factor")
...
gr3 = ROOT.TGraph(len(redFactor3), np.array(effReco3, 'float64'), np.array(redFactor3, 'float64')) #graph object with error bars using arrays of data
gr3.SetTitle("ISR 1: Reduction Factor vs Filter Efficiency at Reco Cut (110 GeV)")
 
gr3.SetMarkerColor(ROOT.kBlue)
gr3.SetMarkerStyle(ROOT.kFullCircle)
gr3.SetMarkerSize(0.5)
gr3.GetXaxis().SetTitle("Filter Efficiency at Reco Cut Value")
gr3.GetXaxis().CenterTitle()
gr3.GetYaxis().SetTitle("Reduction Factor")
...
gr4 = ROOT.TGraph(len(redFactor4), np.array(effReco4, 'float64'), np.array(redFactor4, 'float64')) #graph object with error bars using arrays of data
gr4.SetTitle("ISR 2: Reduction Factor vs Filter Efficiency at Reco Cut (110 GeV)")

gr4.SetMarkerColor(ROOT.kBlue)
gr4.SetMarkerStyle(ROOT.kFullCircle)
gr4.SetMarkerSize(0.5)
gr4.GetXaxis().SetTitle("Filter Efficiency at Reco Cut Value")
gr4.GetXaxis().CenterTitle()
gr4.GetYaxis().SetTitle("Reduction Factor")
