...
def getBinning(lep, varBins = False, standardBins = False, xmax = 200):
   ...
   if not varBins:
      ...
      if standardBins:
         ...
         if lep == 'el':
            bins['pt'] = [0, 5, 10, 15, 20, xmax]
         elif lep == 'mu':
            bins['pt'] = [0, 3.5, 10, 15, 20, xmax]
...
bins = getBinning(lep, varBins = varBins, standardBins = standardBins, xmax = 30)
...
#eff['2D'].SetMaximum(5)
eff['2D'].GetZaxis().SetRangeUser(0.7,1)

c4 = ROOT.TCanvas("c4", "Canvas 4", 1800, 1500)
eff['2D'].Draw("COLZ TEXTE") #CONT1-5 #plots the graph with axes and points
#alignStats(eff['2D'])
...
binLabels = {\
   'mu':
   {'pt':{1:'3.5-10',2:'10-15', 3:'15-20', 4:'20-25', 5:'25-30'}, 
   'eta':{1:'0-0.9',2:'0.9-1.2', 3:'1.2-2.1', 4:'2.1-2.4'}}, 
   'el':
   {'pt':{1:'5-10',2:'10-15', 3:'15-20', 4:'20-25', 5:'25-30'}, 
