...
regDef = cuts_weights.cuts.addCut(regDef, leadJet + 'Eta_lt_2p4')
...
if applyJetId:
    regDef = cuts_weights.cuts.addCut(regDef, leadJet + 'Id')

if matchHLTjet:
    regDef = cuts_weights.cuts.addCut(regDef, 'dR_%s_leadHLTJet_lt_0p15'%leadJet)
