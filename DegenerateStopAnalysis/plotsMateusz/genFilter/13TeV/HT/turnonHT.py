#turnonHT.py - Imported by filter.py. Plots turn-on curves for MET and HT, as a function of genMET and genHT cuts.

def main(genMETcut, genHTcut): #main function to be imported by filter.py.
   print "\nImporting and executing turnonHT.py script..."
   ...
   *********************************************************************************************************************************************************************\n"
   ...
   'genHTjetEta' : 3 #GenJet eta cut for HT
   })
   ...
   h5.SetName("MET")
   h5.SetTitle("Generated MET & H_{T} Filter Effect on Reconstructed MET")
   h5.Draw() 
   ...
   h6 = drawhist(T2DegSample, var, presel1 + "&&" + gensel1 + "&&" + gensel2) # + HT generator cut
   h6.SetName("MET2")
   h6.Draw("same")
   h6.SetFillColor(0)
   ...
   box3 = makeBox()
   box3.AddText("Cuts:")
   box3.AddText("#bf{HT cut: }" + str(cuts['HT']) + " GeV")
   box3.AddText("#bf{HT Jets p_{T} cut: }" + str(cuts['HTjetPt']) + " GeV")
   box3.AddText("#bf{HT Jets #eta cut: }" + str(cuts['HTjetEta']))
   ...
   #Fitting
   fitFunc.SetParameters(0.5, 140, 40, 0.50) #init: (0.45,60,20,0.6)
   ...
   h17.SetName("HT")
   h17.SetTitle("Generated H_{T} & MET Filter Effect on Reconstructed H_{T}")
   ...
   l5 = makeLegend()
   l5.AddEntry("HT", "H_{T} (no generator cuts)", "F")
   ...
   htTurnon2.SetTitle("H_{T} Turnon Plot (Both Generator Cuts) ; H_{T} / GeV ; Counts")
   ...
   #Write to file
   savedir = "/afs/hephy.at/user/m/mzarucki/www/plots/filter/13TeV/HT/alphaTdef/genJetPt30/eta3/turnons/filter_%s_%s"%(str(cuts["genMET"]),str(cuts["genHT"])) #web address: http://www.hephy.at/user/mzarucki/plots/filter/
   ...
   outfile2.write(\
   "genMET Cut" + "   " + "genHT Cut" + "    " + "MET 1 Red. Factor" + "    " + "MET 1 Reco Eff." + "    " + "MET 2 Red. Factor" + "    " + "MET 2 Reco Eff." + "    " + "HT 1 Red. Factor" + "    " + "HT 1 Reco Eff." + "    " + "HT 2 Red. Factor" + "    " + "HT 2 Reco Eff." + "\n" +\
