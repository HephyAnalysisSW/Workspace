...
path = "/afs/hephy.at/user/m/mzarucki/www/plots/filter/13TeV/HT/ROI" #ROI/
savedir = "/afs/hephy.at/user/m/mzarucki/www/plots/filter/13TeV/HT/ROI/reductionEfficiency/" #web directory http://www.hephy.at/user/mzarucki/plots/filter/
...
outfile = open(savedir + "reductionEfficiencyTableROI.txt", "w")
outfile.write(\
