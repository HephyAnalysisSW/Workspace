#redEffMap.py script - Produces 2D map of reduction factors and efficiencies at reco, for varying genMET and genISRpt cuts.

print "\nExecuting redEffMap.py script..."
...
dir = "/afs/hephy.at/user/m/mzarucki/www/plots/filter/13TeV/ISR/"
...
gr1.SetTitle("Total Reduction Factor (Both Generator Cuts)")
gr1.GetHistogram()
...
gr3.SetTitle("Generated ISR Jet p_{T} Filter Efficiency at Reco Cut Value")
 
gr3.GetHistogram()
gr3.GetXaxis().SetTitle("genMET Cut / GeV")
gr3.GetYaxis().SetTitle("genISR Cut / GeV")
...
gr3.GetXaxis().SetRangeUser(100, 165)
gr3.GetYaxis().SetRangeUser(60, 100)
