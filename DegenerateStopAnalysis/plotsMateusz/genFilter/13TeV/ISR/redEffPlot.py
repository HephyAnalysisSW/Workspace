#redEffPlot.py script - Gen. Filter Reduction Factor vs Efficiency at Reco Cut Plot

print "\nExecuting redEffPlot.py script..."
...
for x in range(len(cuts)/2):
   print x
   print cuts[2*x], cuts[2*x+1]
   latex = ROOT.TLatex(gr2.GetX()[x] + 0.0005, gr2.GetY()[x] + 0.0005, "(" + cuts[2*x] + "," + cuts[2*x+1] + ")")
   latex.SetTextSize(0.03)
   #latex.SetTextColor()
...
gr4.SetTitle("Generated ISR Jet p_{T} Filter Efficiency at Reco Cut Value vs. Reduction Factor")
...
#Save to Web
savedir = "/afs/hephy.at/user/m/mzarucki/www/plots/filter/final/13TeV/reductionEfficiency/"
...
c3.SaveAs(path + "reductionEfficiency/redEffISR1plotROI.root")
c3.SaveAs(path + "reductionEfficiency/redEffISR1plotROI.png")
c3.SaveAs(path + "reductionEfficiency/redEffISR1plotROI.pdf")

c4.SaveAs(path + "reductionEfficiency/redEffISR2plotROI.root")
c4.SaveAs(path + "reductionEfficiency/redEffISR2plotROI.png")
c4.SaveAs(path + "reductionEfficiency/redEffISR2plotROI.pdf")

c4.SaveAs(savedir + "ISR_ROC.root")
c4.SaveAs(savedir + "ISR_ROC.png")
c4.SaveAs(savedir + "ISR_ROC.pdf")
