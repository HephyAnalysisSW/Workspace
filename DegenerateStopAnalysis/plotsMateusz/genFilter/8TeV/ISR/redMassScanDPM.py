...
#Write to file
savedir = "/afs/hephy.at/user/m/mzarucki/www/plots/filter/8TeV/filter_%s_%s/"%(str(cuts["gMET"]),str(cuts["gISR"])) + str(options.stopMasses) #web directory http://www.hephy.at/user/mzarucki/plots/filter/

if not os.path.exists(savedir):
   os.makedirs(savedir)

c1.SaveAs(savedir + "/redMassScan_%s_%s_"%(str(cuts['gMET']), str(cuts['gISR'])) + str(options.jobNumber) + ".root")
c1.SaveAs(savedir + "/redMassScan_%s_%s_"%(str(cuts['gMET']), str(cuts['gISR'])) + str(options.jobNumber) + ".png")
c1.SaveAs(savedir + "/redMassScan_%s_%s_"%(str(cuts['gMET']), str(cuts['gISR'])) + str(options.jobNumber) + ".pdf")
