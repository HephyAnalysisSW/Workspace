...
dir = "/afs/hephy.at/user/m/mzarucki/www/plots/filter/8TeV/ISR/genISRonly/filter_%s_%s/"%(str(cuts["gMET"]),str(cuts["gISR"]))
...
for i in range(1,19):
   files.append(ROOT.TFile(dir + massRanges[0] + "/redMassScan_gISR_%s_"%(str(cuts["gISR"])) + str(i) + ".root", "read"))

for i in range(19,33):
   files.append(ROOT.TFile(dir + massRanges[1] + "/redMassScan_gISR_%s_"%(str(cuts["gISR"])) + str(i) + ".root", "read"))

for i in range(33,44):
   files.append(ROOT.TFile(dir + massRanges[2] + "/redMassScan_gISR_%s_"%(str(cuts["gISR"])) + str(i) + ".root", "read"))

for i in range(44,57):
   files.append(ROOT.TFile(dir + massRanges[3] + "/redMassScan_gISR_%s_"%(str(cuts["gISR"])) + str(i) + ".root", "read"))

for i in range(57,62):
   files.append(ROOT.TFile(dir + massRanges[4] + "/redMassScan_gISR_%s_"%(str(cuts["gISR"])) + str(i) + ".root", "read"))
...
c1.SaveAs(dir + "redMassScanTotal1_gISR_%s"%(str(cuts['gISR'])) + ".root")
c1.SaveAs(dir + "redMassScanTotal1_gISR_%s"%(str(cuts['gISR'])) + ".png")
c1.SaveAs(dir + "redMassScanTotal1_gISR_%s"%(str(cuts['gISR'])) + ".pdf")

c2.SaveAs(dir + "redMassScanTotal2_gISR_%s"%(str(cuts['gISR'])) + ".root")
c2.SaveAs(dir + "redMassScanTotal2_gISR_%s"%(str(cuts['gISR'])) + ".png")
c2.SaveAs(dir + "redMassScanTotal2_gISR_%s"%(str(cuts['gISR'])) + ".pdf")

c3.SaveAs(dir + "redMassScanTotalMap_gISR_%s"%(str(cuts['gISR'])) + ".root")
c3.SaveAs(dir + "redMassScanTotalMap_gISR_%s"%(str(cuts['gISR'])) + ".root")
c3.SaveAs(dir + "redMassScanTotalMap_gISR_%s"%(str(cuts['gISR'])) + ".png")

c4.SaveAs(dir + "redMassScanTotalPlot_gISR_%s"%(str(cuts['gISR'])) + ".pdf")
c4.SaveAs(dir + "redMassScanTotalPlot_gISR_%s"%(str(cuts['gISR'])) + ".png")
c4.SaveAs(dir + "redMassScanTotalPlot_gISR_%s"%(str(cuts['gISR'])) + ".pdf")
