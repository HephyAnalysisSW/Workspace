...
dir = "/afs/hephy.at/user/m/mzarucki/www/plots/filter/8TeV/filter_%s_%s/"%(str(cuts["gMET"]),str(cuts["gISR"])) + massRanges[1] + "/genCutsOnly/hists_%s_%s/"%(str(cuts["gMET"]),str(cuts["gISR"]))
...
stopMs = range(175,226,25) #range(100,401,25)
...
for massPoint in massPoints:
   ...
   #Write to file
   savedir = "/afs/hephy.at/user/m/mzarucki/www/plots/filter/8TeV/filter_%s_%s/"%(str(cuts["gMET"]),str(cuts["gISR"])) + massRanges[1] + "/genCutsOnly/" + massPoint #web directory http://www.hephy.at/user/mzarucki/plots/filter/
...
savedir2 = "/afs/hephy.at/user/m/mzarucki/www/plots/filter/8TeV/filter_%s_%s/"%(str(cuts["gMET"]),str(cuts["gISR"])) + massRanges[1] + "/genCutsOnly" #web directory http://www.hephy.at/user/mzarucki/plots/filter/
