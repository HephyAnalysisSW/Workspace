...
dir = "/afs/hephy.at/user/m/mzarucki/www/plots/filter/8TeV/filter_%s_%s/"%(str(cuts["gMET"]),str(cuts["gISR"]))
...
for i in range(1,19):
   files.append(ROOT.TFile(dir + massRanges[0] + "/redMassScan_%s_%s_"%(str(cuts["gMET"]),str(cuts["gISR"])) + str(i) + ".root", "read"))

for i in range(19,33):
   files.append(ROOT.TFile(dir + massRanges[1] + "/redMassScan_%s_%s_"%(str(cuts["gMET"]),str(cuts["gISR"])) + str(i) + ".root", "read"))

for i in range(33,44):
   files.append(ROOT.TFile(dir + massRanges[2] + "/redMassScan_%s_%s_"%(str(cuts["gMET"]),str(cuts["gISR"])) + str(i) + ".root", "read"))

for i in range(44,57):
   files.append(ROOT.TFile(dir + massRanges[3] + "/redMassScan_%s_%s_"%(str(cuts["gMET"]),str(cuts["gISR"])) + str(i) + ".root", "read"))

for i in range(57,62):
   files.append(ROOT.TFile(dir + massRanges[4] + "/redMassScan_%s_%s_"%(str(cuts["gMET"]),str(cuts["gISR"])) + str(i) + ".root", "read"))
...
c1.cd(1)
total.SetTitle("Total Number of Events per Mass Point")
...
c1.cd(2)
passed.SetTitle("Passed Generator Filter Events per Mass Point")
...
c2.cd(1)
redFactor = ROOT.TH2F("redFactor", "Reduction Factor per Mass Point Map", 80, 50, 450, 18, 0, 90)
...
c2.cd(2)
redFactorPlot = ROOT.TH1F("redFactorPlot", "Reduction Factor vs. Mass Point Plot", 105, 0, 105)
...
c1.SaveAs(savedir + "redMassScanTotal1_%s_%s"%(str(cuts['gMET']), str(cuts['gISR'])) + ".root")
c1.SaveAs(savedir + "redMassScanTotal1_%s_%s"%(str(cuts['gMET']), str(cuts['gISR'])) + ".png")
c1.SaveAs(savedir + "redMassScanTotal1_%s_%s"%(str(cuts['gMET']), str(cuts['gISR'])) + ".pdf")

c2.SaveAs(savedir + "redMassScanTotal2_%s_%s"%(str(cuts['gMET']), str(cuts['gISR'])) + ".root")
c2.SaveAs(savedir + "redMassScanTotal2_%s_%s"%(str(cuts['gMET']), str(cuts['gISR'])) + ".png")
c2.SaveAs(savedir + "redMassScanTotal2_%s_%s"%(str(cuts['gMET']), str(cuts['gISR'])) + ".pdf")

c3.SaveAs(savedir + "redMassScanTotalMap_%s_%s"%(str(cuts['gMET']), str(cuts['gISR'])) + ".root")
c3.SaveAs(savedir + "redMassScanTotalMap_%s_%s"%(str(cuts['gMET']), str(cuts['gISR'])) + ".root")
c3.SaveAs(savedir + "redMassScanTotalMap_%s_%s"%(str(cuts['gMET']), str(cuts['gISR'])) + ".png")

c4.SaveAs(savedir + "redMassScanTotalPlot_%s_%s"%(str(cuts['gMET']), str(cuts['gISR'])) + ".pdf")
c4.SaveAs(savedir + "redMassScanTotalPlot_%s_%s"%(str(cuts['gMET']), str(cuts['gISR'])) + ".png")
c4.SaveAs(savedir + "redMassScanTotalPlot_%s_%s"%(str(cuts['gMET']), str(cuts['gISR'])) + ".pdf")
