...
dir = "/afs/hephy.at/user/m/mzarucki/www/plots/filter/8TeV/HT/filter_%s_%s/"%(str(cuts["genMET"]),str(cuts["genHT"]))
...
for i in range(1,19):
   files.append(ROOT.TFile(dir + massRanges[0] + "/redMassScanHT_%s_%s_"%(str(cuts["genMET"]),str(cuts["genHT"])) + str(i) + ".root", "read"))

for i in range(19,33):
   files.append(ROOT.TFile(dir + massRanges[1] + "/redMassScanHT_%s_%s_"%(str(cuts["genMET"]),str(cuts["genHT"])) + str(i) + ".root", "read"))

for i in range(33,44):
   files.append(ROOT.TFile(dir + massRanges[2] + "/redMassScanHT_%s_%s_"%(str(cuts["genMET"]),str(cuts["genHT"])) + str(i) + ".root", "read"))

for i in range(44,57):
   files.append(ROOT.TFile(dir + massRanges[3] + "/redMassScanHT_%s_%s_"%(str(cuts["genMET"]),str(cuts["genHT"])) + str(i) + ".root", "read"))

for i in range(57,62):
   files.append(ROOT.TFile(dir + massRanges[4] + "/redMassScanHT_%s_%s_"%(str(cuts["genMET"]),str(cuts["genHT"])) + str(i) + ".root", "read"))
...
c1.cd(1)
total.SetTitle("Generated MET & H_{T} Filter: Total Number of Events per Mass Point for (genMET, genHT) > (" + str(cuts['genMET']) + "," + str(cuts['genHT']) + ") GeV")
...
c1.cd(2)
passed.SetTitle("Generated MET & H_{T} Filter: Passed Generator Filter Events per Mass Point for (genMET, genHT) > (" + str(cuts['genMET']) + "," + str(cuts['genHT']) + ") GeV")
...
c2.cd(1)
redFactor = ROOT.TH2F("redFactor", "Generated MET & H_{T} Filter: Reduction Factor per Mass Point Map for (genMET, genHT) > (" + str(cuts['genMET']) + "," + str(cuts['genHT']) + ") GeV", 80, 50, 450, 18, 0, 90)
...
c2.cd(2)
redFactorPlot = ROOT.TH1F("redFactorPlot", "Generated MET & H_{T} Filter: Reduction Factor vs. Mass Point Plot for (genMET, genHT) > (" + str(cuts['genMET']) + "," + str(cuts['genHT']) + ") GeV", 105, 0, 105)
...
#Write to file
savedir = "/afs/hephy.at/user/m/mzarucki/www/plots/filter/8TeV/HT/filter_%s_%s/"%(str(cuts["genMET"]),str(cuts["genHT"])) #web directory http://www.hephy.at/user/mzarucki/plots/filter/

if not os.path.exists(savedir):
   os.makedirs(savedir)

c1.SaveAs(savedir + "redMassScanTotal1_%s_%s"%(str(cuts['genMET']), str(cuts['genHT'])) + ".root")
c1.SaveAs(savedir + "redMassScanTotal1_%s_%s"%(str(cuts['genMET']), str(cuts['genHT'])) + ".png")
c1.SaveAs(savedir + "redMassScanTotal1_%s_%s"%(str(cuts['genMET']), str(cuts['genHT'])) + ".pdf")

c2.SaveAs(savedir + "redMassScanTotal2_%s_%s"%(str(cuts['genMET']), str(cuts['genHT'])) + ".root")
c2.SaveAs(savedir + "redMassScanTotal2_%s_%s"%(str(cuts['genMET']), str(cuts['genHT'])) + ".png")
c2.SaveAs(savedir + "redMassScanTotal2_%s_%s"%(str(cuts['genMET']), str(cuts['genHT'])) + ".pdf")

c3.SaveAs(savedir + "redMassScanTotalMap_%s_%s"%(str(cuts['genMET']), str(cuts['genHT'])) + ".root")
c3.SaveAs(savedir + "redMassScanTotalMap_%s_%s"%(str(cuts['genMET']), str(cuts['genHT'])) + ".root")
c3.SaveAs(savedir + "redMassScanTotalMap_%s_%s"%(str(cuts['genMET']), str(cuts['genHT'])) + ".png")

c4.SaveAs(savedir + "redMassScanTotalPlot_%s_%s"%(str(cuts['genMET']), str(cuts['genHT'])) + ".pdf")
c4.SaveAs(savedir + "redMassScanTotalPlot_%s_%s"%(str(cuts['genMET']), str(cuts['genHT'])) + ".png")
c4.SaveAs(savedir + "redMassScanTotalPlot_%s_%s"%(str(cuts['genMET']), str(cuts['genHT'])) + ".pdf")
