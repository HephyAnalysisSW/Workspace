...
plots2 = drawPlots(samples, plotsDict, presel, samplesList, plotList = plotsList, plotLimits = [1, 100], denoms=["bkg"], noms = ["dblind"], fom="RATIO", fomLimits=[0,2.8], normalize = False, save=False) #, plotMin = 0.1
