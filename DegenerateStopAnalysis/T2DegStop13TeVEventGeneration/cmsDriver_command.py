...
#cmsDriver.py step3 --filein file:step2.root --fileout file:MINIAOD.root --mc --eventcontent MINIAODSIM --runUnscheduled --datatier MINIAODSIM --conditions PHYS14_25_V1 --step PAT
