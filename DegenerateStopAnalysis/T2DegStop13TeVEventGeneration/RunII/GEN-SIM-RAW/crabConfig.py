...
signalName = 'T2tt_dM-10to80_privGridpack_LHE-GEN-SIM-RAW_mStop-%s_mLSP-%s_noPU'%(mStop,mLSP)
...
config.JobType.inputFiles = ['/afs/cern.ch/work/m/mzarucki/data/gridpacks/%s'%gridpack]
config.JobType.pyCfgParams = ['gridpack=../'+gridpack, 'mStop='+mStop, 'mLSP='+mLSP]
config.JobType.pluginName = 'PrivateMC'
config.JobType.psetName = 'T2tt_dM-10to80_fragment_onePoint_privGridpack_py_LHE_GEN-SIM-RAW_noPU.py' # Name of the CMSSW configuration file
