...
# with command line options: step3 --mc --filein file:step2_RAW2DIGI_L1Reco_RECO_EI.root --conditions MCRUN2_74_V9 --eventcontent MINIAODSIM --runUnscheduled -s PAT --datatier MINIAODSIM --customise SLHCUpgradeSimulations/Configuration/postLS1Customs.customisePostLS1 --python_filename step3_miniAOD_cfg.py --no_exec
