...
# with command line options: Configuration/GenProduction/python/genfragment_cff.py --filein file:/afs/cern.ch/work/n/nrad/private/T2DegStop/13TeVGeneration/LHE/T2DegStop2j_300_270_merged.lhe --fileout file:GENSIM.root --mc --eventcontent RAWSIM --customise SLHCUpgradeSimulations/Configuration/postLS1Customs.customisePostLS1,Configuration/DataProcessing/Utils.addMonitoring --datatier GEN-SIM --conditions MCRUN2_71_V1::All --beamspot NominalCollision2015 --step GEN,SIM --magField 38T_PostLS1 --no_exec -n 147 --python_filename step0_GENSIM_cfg.py
...
process.maxEvents = cms.untracked.PSet(
    input = cms.untracked.int32(147)
)

# Input source
process.source = cms.Source("LHESource",
    #fileNames = cms.untracked.vstring('file:/afs/cern.ch/work/n/nrad/private/T2DegStop/13TeVGeneration/LHE/T2DegStop2j_300_270_merged.lhe'),
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('T2DegStop_300_270_GENSIM.root'),
