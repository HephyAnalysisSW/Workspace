...
# with command line options: step2 --mc --filein file:step1_DIGI_L1_DIGI2RAW_HLT_PU.root --conditions MCRUN2_74_V9 -s RAW2DIGI,L1Reco,RECO,EI --datatier AODSIM --customise SLHCUpgradeSimulations/Configuration/postLS1Customs.customisePostLS1 --eventcontent AODSIM --magField 38T_PostLS1 --no_exec
