...
sampleDict={
          'W':          {'tree':WJets[0] , 'color':424      ,'nEventsTot':WJets[1] , 'isSignal':0 , 'isData':0   ,'xsec':20508.9*3    },
          "s":       {'tree':T2Deg[0] , 'color':ROOT.kRed,   'nEventsTot':T2Deg[1] ,  'isSignal':1 , 'isData':0  ,'xsec':8.51615    },
          #'TTs': {'tree':getChain(ttJets['soft'],histname='') ,               'color':1    , 'isSignal':0 , 'isData':0       },            
       }

for samp in sampleDict:
  sampleDict[samp]['weight']=target_lumi*sampleDict[samp]['xsec']/sampleDict[samp]['nEventsTot']
