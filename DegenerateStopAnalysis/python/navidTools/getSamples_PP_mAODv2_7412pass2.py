...
##TTSample    = getChain(TTJets[skim],histname='') 
##
...
#
#WSample = WJetsIncSample
#
#
#
#TTJetsIncSample = getChain(TTJetsInc[skim],histname='')
##TTJetsHT0   =   getChain(TTJetsHT0to600[skim],histname='') 
##TTJetsHT1   =   getChain(TTJetsHT600to800[skim],histname='')
##TTJetsHT2   =   getChain(TTJetsHT800toInf[skim],histname='')
##
##
##TTJetsSample = TTJetsHT0.Clone()
##TTJetsSample.Add(TTJetsHT1)
##TTJetsSample.Add(TTJetsHT2)
##WJetsSample = getChain(WJetsInc[skim],histname='')
#
