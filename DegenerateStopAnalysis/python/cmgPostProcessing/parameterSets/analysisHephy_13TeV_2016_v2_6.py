...
def treeVariables(args):
    ...
    # 
    readVariables_DATAMC = ['nFatJet/I']
    newVariables_DATAMC = []

    readVectors_DATAMC = [{'prefix':'Jet',    'vars':['isIsr/I', 'partonFlavour/I'], 'nMax':25, 'size':'nJet/I'},
                          {'prefix':'FatJet', 'vars':['eta/F', 'phi/F', 'isIsr/I', 'partonFlavour/I'], 'nMax':15, 'size':'nFatJet/I'}]
    newVectors_DATAMC = []
   ...
   # MC samples only
    ...
    aliases_MC.extend(['genMet:met_genPt', 'genMetPhi:met_genPhi'])
     ...
     # 
    readVariables_MC = ['nGenJet/I']
    newVariables_MC = []

    readVectors_MC = [{'prefix':'GenJet', 'vars':['eta/F', 'phi/F', 'isIsr/I'], 'nMax':30, 'size':'nGenJet/I'}]
    newVectors_MC = []
    ...
    aliases_DATA = []
     ...
     # 
    readVariables_DATA = []
    newVariables_DATA = ['isFromSingleElPD/I/1', 'isFromSingleMuPD/I/1']
...
def getParameterSet(args):
    ...
    LepGood_extend_DATAMC = {
        ...
        'extendVariables': [
                ...
                {
                 'var': 'recoil_j1VsWpt/F/0', 'function': 'extend_LepGood_func', 'args':{}, 'eval_begin': 0
                },
             ]
    }
    ...
    LepGood_extend_MC = {
        ...
        'extendVariables': [
            {
                'var': 'isFakeFromTau/I/0', 'function': 'extend_LepGood_func', 'args':{'dRcut':0.15}, 'eval_begin': 1
            },
        ],
    }
    ...
    Jet_extend_DATAMC = {
        ...
        'extendVariables': [
                {
                 'var': 'recoil_jVsMET/F/0', 'function': 'extend_Jet_func', 'args':{}, 'eval_begin': 1
                },
             ]
    }

    extendCollectionList.append(Jet_extend_DATAMC)
    ...
    Jet_extend_MC = {
        ...
        'extendVariables': [
                {
                 'var': 'isTrueIsr/I/0', 'function': 'extend_Jet_func', 'args':{'dRcut':0.15}, 'eval_begin': 1
                },
                {
                 'var': 'flavIsr/I/0', 'function': 'extend_Jet_func', 'args':{}, 'eval_begin': 1
                },
             ]
    }

    extendCollectionList.append(Jet_extend_MC)
    ...
    extendCollectionList.append(FatJet_extend_MC)
    ...
    extendCollectionList.append(GenJet_extend_MC)
    ...
    sort_wrt_Wpeak = False # NOTE: indices sorted wrt. mT closest to W-peak. Not added by default.
    
    if sort_wrt_Wpeak: 

      LepGood_mu_def_sortWpeak = { # Also corresponds to Tight in Fake Rate definition
          'branchPrefix': 'LepGood',
          'object': 'mu',
          'selectorId': 'def_sortWpeak',
          'sampleType': ['data', 'mc'],
          'inputIndexList': None,
          'branchesToRead': branchesToRead_mu,
          'branchesToPrint': branchesToPrint_mu,
      ...
      selectorList.append(LepGood_mu_def_sortWpeak)

      # Selector for Loose Fake Rate definition 

      LepGood_mu_loose_def_sortWpeak = { #NOTE: should correspond exactly to CMG selection on LepGood and only split between electrons and muons
          'branchPrefix': 'LepGood',
          'object': 'mu',
          'selectorId': 'loose_sortWpeak',
          'sampleType': ['data', 'mc'],
          'inputIndexList': None,
          'branchesToRead': branchesToRead_mu,
          'branchesToPrint': branchesToPrint_mu,
      ...
      selectorList.append(LepGood_mu_loose_def_sortWpeak)

      # Electrons

      LepGood_el_def_sortWpeak = {# Also corresponds to Tight in Fake Rate definition
          'branchPrefix': 'LepGood',
          'object': 'el',
          'selectorId': 'def_sortWpeak',
          'sampleType': ['data', 'mc'],
      ...
      selectorList.append(LepGood_el_def_sortWpeak)

      LepGood_el_loose_def_sortWpeak = { #NOTE: should correspond exactly to CMG selection on LepGood and only split between electrons and muons
          'branchPrefix': 'LepGood',
          'object': 'el',
          'selectorId': 'loose_sortWpeak',
          'sampleType': ['data', 'mc'],
      ...
      selectorList.append(LepGood_el_loose_def_sortWpeak)

      mergeLeptonSelectors.append((LepGood_mu_def_sortWpeak, LepGood_el_def_sortWpeak))
      mergeLeptonSelectors.append((LepGood_mu_loose_def_sortWpeak, LepGood_el_loose_def_sortWpeak))
