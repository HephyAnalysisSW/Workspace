...
def getSampleSets(args):
    ...
    sampleSets = {
       ...
       #'ewk': {
       #              'samples':[
       #                            [  'SMS_C1C1_higgsino_genHT_160_genMET_80_3p',  ,  ] + signalOpts,  

       #                            [  'SMS_C1N1_higgsino_genHT_160_genMET_80_3p',  ,  ] + signalOpts,  

       #                            [  'SMS_N2C1_higgsino_genHT_160_genMET_80_3p',  ,  ] + signalOpts,   

       #                            [  'SMS_N2N1_higgsino_genHT_160_genMET_80_3p',  ,  ] + signalOpts,   

       #                            [  'SMS_TChiWZ_genHT_160_genMET_80_3p',         ,  ] + signalOpts,   
