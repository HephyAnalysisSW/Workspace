...
ipython   degStop.py -- --cfg=ApprovalSys --task=bkg_est --lepCol=LepAll --lep=lep  --weight=pu_Q2centralcentral     --btag=SF  --redo_yields  --cut=bins_sum
ipython   degStop.py -- --cfg=ApprovalSys --task=bkg_est --lepCol=LepAll --lep=lep  --weight=pu_Q2centralup          --btag=SF  --redo_yields  --cut=bins_sum
ipython   degStop.py -- --cfg=ApprovalSys --task=bkg_est --lepCol=LepAll --lep=lep  --weight=pu_Q2centraldown        --btag=SF  --redo_yields  --cut=bins_sum
ipython   degStop.py -- --cfg=ApprovalSys --task=bkg_est --lepCol=LepAll --lep=lep  --weight=pu_Q2upcentral          --btag=SF  --redo_yields  --cut=bins_sum
ipython   degStop.py -- --cfg=ApprovalSys --task=bkg_est --lepCol=LepAll --lep=lep  --weight=pu_Q2downcentral        --btag=SF  --redo_yields  --cut=bins_sum
ipython   degStop.py -- --cfg=ApprovalSys --task=bkg_est --lepCol=LepAll --lep=lep  --weight=pu_Q2updown             --btag=SF  --redo_yields  --cut=bins_sum
ipython   degStop.py -- --cfg=ApprovalSys --task=bkg_est --lepCol=LepAll --lep=lep  --weight=pu_Q2downup             --btag=SF  --redo_yields  --cut=bins_sum


#ipython   degStop.py -- --cfg=ApprovalSys --task=bkg_est --lepCol=LepAll --lep=lep  --weight=pu_Q2upup          --btag=SF  --redo_yields  --cut=bins_sum
