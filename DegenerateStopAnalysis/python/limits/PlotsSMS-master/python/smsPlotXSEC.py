...
class smsPlotXSEC(smsPlotABS):
    ...
    def __init__(self, modelname, histo, obsLimits, expLimits, energy, lumi, preliminary, label, analysis):
        self.standardDef(modelname, histo, obsLimits, expLimits, energy, lumi, preliminary, analysis)
        self.LABEL = label
        # canvas for the plot
