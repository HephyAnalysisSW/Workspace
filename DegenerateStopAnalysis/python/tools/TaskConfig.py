...
class TaskConfig():
    ...
    def __init__(self,  
        ...
        self.signal_path   = "/afs/hephy.at/data/nrad01/cmgTuples/postProcessed_mAODv2/{cmgTag}/{ppTag}_1/{parameterSet}/{ppStep}/{mc_path_tag}_{cmgTagV}/".format(ppTag=ppTag,ppStep=self.ppStep, ppUser = self.ppUser , cmgTag = self.cmgTag, cmgTagV = self.cmgTagVer, parameterSet=self.parameterSet, mc_path_tag= mc_path_tag)
        self.data_path     = "/afs/hephy.at/data/{ppUser}/cmgTuples/postProcessed_mAODv2/{cmgTag}/{ppTag}_1/{parameterSet}/{ppStep}/{data_path_tag}_{cmgTagV}_2/".format(ppTag=ppTag,ppStep=self.ppStep, ppUser = self.ppUser , cmgTag = self.cmgTag, cmgTagV = self.cmgTagVer, parameterSet=self.parameterSet, data_path_tag= data_path_tag)
