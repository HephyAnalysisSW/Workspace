        ...
        plotDict =\
              {
                ...
                "ct1":           {'var':"min(met_pt,ht_{jet}-100)".format(**fargs)         ,"bins":[40,100,1000]        ,"nMinus1":""           ,"decor":{"title":"CT1"    ,"x":"C_{T1} [GeV]"      ,"y":"Events"  ,'log':[0,1,0] }},
                "ct2":           {'var':"min(met_pt, Jet_pt[{jetIndex}[0]] - 25)".format(**fargs)         ,"bins":[40,100,1000]        ,"nMinus1":""           ,"decor":{"title":"CT2"    ,"x":"C_{T2} [GeV]"      ,"y":"Events"  ,'log':[0,1,0] }},
