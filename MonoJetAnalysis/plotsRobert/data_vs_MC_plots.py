...
if presel == "inc":
  commoncf="(1)"
if presel == "incMu":
  commoncf="softIsolatedMuPt>5&&nHardElectrons+nHardMuons==0"
#  commoncf="njet<=3"
if presel == "inclusive":
  commoncf="(1)"
#  commoncf="njet<=3"
...
for sample in allSamples:
  ...
  sample["dirname"] = "/data/schoef/monoJetTuples_v1/"+chmode+"/"
...
#  allStacks.append(ptw_stack)
  ...
  softIsolatedMuAbsIso_stack = getStack(":XXX;I_{abs.} of soft isolated muon;Number of Events",[30,0,6], commoncf, signals, lambda c: c.GetLeaf('softIsolatedMuRelIso').GetValue()*c.GetLeaf('softIsolatedMuPt').GetValue(), addData = addData)
  ...
  softIsolatedMuDz_stack = getStack(":softIsolatedMuDz;d_{z} of soft isolated muon;Number of Events",[40,0,20], commoncf, signals, addData = addData)
