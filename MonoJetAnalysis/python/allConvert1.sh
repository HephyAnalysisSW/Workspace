...
#python convert.py --samples=zinv            --chmode=$1 $2 &
#python convert.py --samples=zinv            --chmode=copy --fromPercentage=0 --toPercentage=20   &
#python convert.py --samples=zinv            --chmode=copy --fromPercentage=20 --toPercentage=40  &
#python convert.py --samples=zinv            --chmode=copy --fromPercentage=40 --toPercentage=60  &
#python convert.py --samples=zinv            --chmode=copy --fromPercentage=60 --toPercentage=80  &
#python convert.py --samples=zinv            --chmode=copy --fromPercentage=80 --toPercentage=100 &
