...
stop300lsp270g200FullSim["dirname"]  = "/data/schoef/monoJetTuples_v5/copy/"
...
stop300lsp270g175FullSim["dirname"]  = "/data/schoef/monoJetTuples_v5/copy/"
...
stop300lsp270FullSim["dirname"]  = "/data/schoef/monoJetTuples_v5/copy/"
...
stop200lsp170g100FullSim["dirname"]  = "/data/schoef/monoJetTuples_v5/copy/"
...
stop300lsp240g150FullSim["dirname"]  = "/data/schoef/monoJetTuples_v5/copy/"
...
stop300lsp270g200FastSim["dirname"]  = "/data/schoef/monoJetTuples_v5/copy/"
...
stop300lsp270g175FastSim["dirname"]  = "/data/schoef/monoJetTuples_v5/copy/"
...
stop300lsp270FastSim["dirname"]  = "/data/schoef/monoJetTuples_v5/copy/"
...
stop200lsp170g100FastSim["dirname"]  = "/data/schoef/monoJetTuples_v5/copy/"
...
stop300lsp240g150FastSim["dirname"]  = "/data/schoef/monoJetTuples_v5/copy/"
...
data["name"]    = "data"
data["hasWeight"]     = True
data["dirname"] = "/data/schoef/monoJetTuples_v5/copy/" 
...
dataSingleMu["dirname"] = "/data/schoef/monoJetTuples_v5/copyMu/" 

dy = {}
dy["bins"]    = ["DY"]
dy["name"]    = "DY"
dy["hasWeight"]     = True
dy["dirname"] = "/data/schoef/monoJetTuples_v5/copy/" 

ww = {}
ww["bins"]    = ["WW"]
ww["name"]    = "WW"
ww["hasWeight"]     = True
ww["dirname"] = "/data/schoef/monoJetTuples_v5/copy/" 

wz = {}
wz["bins"]    = ["WZ"]
wz["name"]    = "WZ"
wz["hasWeight"]     = True
wz["dirname"] = "/data/schoef/monoJetTuples_v5/copy/" 

zz = {}
zz["bins"]    = ["ZZ"]
zz["name"]    = "ZZ"
zz["hasWeight"]     = True
zz["dirname"] = "/data/schoef/monoJetTuples_v5/copy/" 

vv = {}
vv["bins"]    = ["ZZ", "WW", "WZ"]
vv["name"]    = "VV"
vv["hasWeight"]     = True
vv["dirname"] = "/data/schoef/monoJetTuples_v5/copy/" 

dy_and_ww = {}
dy_and_ww["bins"]    = ["DY", "WW"]
dy_and_ww["name"]    = "DY_and_WW"
dy_and_ww["hasWeight"]     = True
dy_and_ww["dirname"] = "/data/schoef/monoJetTuples_v5/copy/" 
...
wJetsToLNu_and_bb["dirname"] = "/data/schoef/monoJetTuples_v5/copy/" 
...
qcd["name"]    = "QCD"
qcd["hasWeight"]     = True
qcd["dirname"] = "/data/schoef/monoJetTuples_v5/copy/" 

singleTop = {}
singleTop["bins"]    = ["singleTop"]
singleTop["name"]    = "singleTop"
singleTop["hasWeight"]     = True
singleTop["dirname"] = "/data/schoef/monoJetTuples_v5/copy/" 
