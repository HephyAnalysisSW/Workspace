...
stop300lsp270g200FullSim["dirname"]  = "/data/schoef/monoJetTuples_v2/copy/"
...
stop300lsp270g175FullSim["dirname"]  = "/data/schoef/monoJetTuples_v2/copy/"
...
stop300lsp270FullSim["dirname"]  = "/data/schoef/monoJetTuples_v2/copy/"
...
stop200lsp170g100FullSim["dirname"]  = "/data/schoef/monoJetTuples_v2/copy/"
...
stop300lsp240g150FullSim["dirname"]  = "/data/schoef/monoJetTuples_v2/copy/"
...
stop300lsp270g200FastSim["dirname"]  = "/data/schoef/monoJetTuples_v2/copy/"
...
stop300lsp270g175FastSim["dirname"]  = "/data/schoef/monoJetTuples_v2/copy/"
...
stop300lsp270FastSim["dirname"]  = "/data/schoef/monoJetTuples_v2/copy/"
...
stop200lsp170g100FastSim["dirname"]  = "/data/schoef/monoJetTuples_v2/copy/"
...
data["name"]    = "data"
data["hasWeight"]     = True
data["dirname"] = "/data/schoef/monoJetTuples_v2/copy/" 

dy = {}
dy["bins"]    = ["DY"]
dy["name"]    = "DY"
dy["hasWeight"]     = True
dy["dirname"] = "/data/schoef/monoJetTuples_v2/copy/" 

ttJets = {}
ttJets["bins"]    = ["TTJets"]
ttJets["name"]    = "TTJets"
ttJets["hasWeight"]     = True
ttJets["dirname"] = "/data/schoef/monoJetTuples_v2/copy/" 

zJetsInv = {}
zJetsInv["bins"]    = ["ZJetsInv"]
zJetsInv["name"]    = "ZJetsInv"
zJetsInv["hasWeight"]     = True
zJetsInv["dirname"] = "/data/schoef/monoJetTuples_v2/copy/" 

wJetsToLNu = {}
wJetsToLNu["bins"]    = ["W1JetsToLNu", "W2JetsToLNu", "W3JetsToLNu", "W4JetsToLNu"]
wJetsToLNu["name"]    = "WJetsToLNu"
wJetsToLNu["hasWeight"]     = True
wJetsToLNu["dirname"] = "/data/schoef/monoJetTuples_v2/copy/" 

#wJetsToLNuInc = {}
#wJetsToLNuInc["bins"]    = ["WJetsToLNu"]
#wJetsToLNuInc["name"]    = "WJetsToLNuInc"
#wJetsToLNuInc["hasWeight"]     = True
#wJetsToLNuInc["dirname"] = "/data/schoef/monoJetTuples_v2/copy/" 
...
qcd["name"]    = "QCD"
qcd["hasWeight"]     = True
qcd["dirname"] = "/data/schoef/monoJetTuples_v2/copy/" 

singleTop = {}
singleTop["bins"]    = ["singleTop"]
singleTop["name"]    = "singleTop"
singleTop["hasWeight"]     = True
singleTop["dirname"] = "/data/schoef/monoJetTuples_v2/copy/" 
