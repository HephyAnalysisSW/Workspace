...
process.load('Workspace.GenHTFilter.genHTFilter_cfi')
...
process.source = cms.Source("LHESource",
    ...
    fileNames = cms.untracked.vstring('file://data/imikulec/lhe15/T2DegStop2j_300_270_merged.lhe')
)
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/SUS-RunIISpring15FSPremix-00002-fragment.py nevts:100'),
...
process.AODSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('T2DegStop2j_300_270_FastSim_filtered.root'),
...
#process.ProductionFilterSequence.insert(process.filter_step)
