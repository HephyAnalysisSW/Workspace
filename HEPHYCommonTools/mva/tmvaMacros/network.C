...
Bool_t MovieMode = kFALSE; //Default is kFALSE!!
                   ...
                   Bool_t movieMode = kFALSE, const TString& epoch = "" )
{
   ...
   if (MovieMode) {
      ...
      cout << "Name of dir "<<d->GetName() << endl;
      TString nameOfDir= d->GetName();
      cout << "Test "<<nameOfDir <<endl;
      TString fname = "plots/" + nameOfDir;
//    cout << "Now Position here, Name: plots/"<<test << endl;
