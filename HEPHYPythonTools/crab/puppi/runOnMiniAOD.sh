...
export FILENAME="${3:-"afafaffile:/data/nrad/local/Spring14_TTJets_MiniAOD/Spring14dr_TTJets_MSDecaysCKM_central_Tune4C_13TeV-madgraph-tauola_AODSIM_PU_S14_POSTLS170_V6-v1MINIAOD.root"}"
...
export PUPPIOUT=`echo ${FILENAME} | sed "s/.root/Puppi$PUPPISTEP.root/g" | sed "s/\/Spring14_TTJets_MiniAOD//g"`
export TUPELOUT=`echo ${PUPPIOUT} | sed "s/.root/Tupel.root/g"`
export CONVERTOUT=`echo ${TUPELOUT} | sed "s/.root/_converted.root/g"`
...
echo $TUPELOUT
echo "....................."
cmsRun ../defaultMINIAODTupelizer_cfg.py files=$OUTDIR$PUPPIOUT  maxEvents=$MAXEVENTS outfile=$OUTDIR$TUPELOUT  keep="*_genMetTrue_*_*,*_pfMet_*_*,*_packedPFCandidates_*_*,*_prunedGenParticles_*_*,*_packedGenParticles_*_*,*_*uppi*_*_*,*_*_*uppi*_*" 
